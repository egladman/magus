...
<!-- magus:skills:begin generated by: magus agent install; agent-skill-version: 51; knowledge-schema-version: 10; skill-content: a0c744d9aca6; do not edit - magus never writes this file, so re-run `magus agent install` and replace this block to update -->
