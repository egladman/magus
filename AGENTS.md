...
<!-- magus:skills:begin generated by: magus agent install; agent-skill-version: 61; knowledge-schema-version: 11; skill-content: b5a1274c89b4; do not edit - magus never writes this file, so re-run `magus agent install` and replace this block to update -->
