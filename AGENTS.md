...
<!-- magus:skills:begin generated by: magus agent install; agent-skill-version: 56; knowledge-schema-version: 11; skill-content: ce13c82386eb; do not edit - magus never writes this file, so re-run `magus agent install` and replace this block to update -->
