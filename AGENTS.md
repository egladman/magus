...
<!-- magus:skills:begin generated by: magus agent install; agent-skill-version: 70; knowledge-schema-version: 12; skill-content: 90304458562a; do not edit - magus never writes this file, so re-run `magus agent install` and replace this block to update -->
