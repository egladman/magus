...
<!-- magus:skills:begin generated by: magus agent install; agent-skill-version: 45; knowledge-schema-version: 9; skill-content: a754ee4f86d9; do not edit - magus never writes this file, so re-run `magus agent install` and replace this block to update -->
