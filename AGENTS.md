...
<!-- magus:skills:begin generated by: magus agent install; agent-skill-version: 49; knowledge-schema-version: 10; skill-content: d57aa6570b6b; do not edit - magus never writes this file, so re-run `magus agent install` and replace this block to update -->
