...
<!-- magus:skills:begin generated by: magus agent install; agent-skill-version: 34; knowledge-schema-version: 9; skill-content: a4e5b76440c9; do not edit - magus never writes this file, so re-run `magus agent install` and replace this block to update -->
