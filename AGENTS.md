...
<!-- magus:skills:begin generated by: magus agent install; agent-skill-version: 86; knowledge-schema-version: 14; skill-content: 576bd9b3643b; do not edit - magus never writes this file, so re-run `magus agent install` and replace this block to update -->
