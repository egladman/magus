...
<!-- magus:skills:begin generated by: magus agent install; agent-skill-version: 81; knowledge-schema-version: 12; skill-content: de3e052bb5b6; do not edit - magus never writes this file, so re-run `magus agent install` and replace this block to update -->
