...
<!-- magus:skills:begin generated by: magus agent install; agent-skill-version: 39; knowledge-schema-version: 9; skill-content: b734857d196a; do not edit - magus never writes this file, so re-run `magus agent install` and replace this block to update -->
