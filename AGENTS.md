...
<!-- magus:skills:begin generated by: magus agent install; agent-skill-version: 85; knowledge-schema-version: 13; skill-content: 774924004d82; do not edit - magus never writes this file, so re-run `magus agent install` and replace this block to update -->
