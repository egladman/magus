...
<!-- magus:skills:begin generated by: magus agent install; agent-skill-version: 57; knowledge-schema-version: 11; skill-content: 31921c30b52a; do not edit - magus never writes this file, so re-run `magus agent install` and replace this block to update -->
