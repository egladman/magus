...
<!-- magus:skills:begin generated by: magus agent install; agent-skill-version: 43; knowledge-schema-version: 9; skill-content: ca8cc03c2369; do not edit - magus never writes this file, so re-run `magus agent install` and replace this block to update -->
