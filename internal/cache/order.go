...
// the step's whole run. Nil means the reader has to wait out the writer step itself,
// which happens when a writer's key is a batch step's: that step's own end already speaks
// for it.
//
