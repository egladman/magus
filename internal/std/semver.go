...
//go:generate go run ../../cmd/magus-bindings-gen -module semver -lang buzz -out gen/buzz/semver.go
...
func SemverParse(_ context.Context, v string) (map[string]any, error) {
