...
var allChecks = []checkDef{
	...
	},
	{
		...
		Evidence: types.EvidenceMeasured,
		run:      func(r *runner, _ []*types.Project) types.DoctorCheck { return r.checkTokens() },
	},
	{
		Name:           "mcp-client",
	...
	},
	{
		...
		Evidence:       types.EvidenceInferred,
		NeedsWorkspace: true,
		run:            func(r *runner, _ []*types.Project) types.DoctorCheck { return r.checkRecurringGuardDenials() },
	},
	{
