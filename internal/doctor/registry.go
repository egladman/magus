...
type checkDef struct {
	...
	run func(r *runner, projects []*types.Project) types.Check
}
...
var allChecks = []checkDef{
	{
		...
		run:      func(r *runner, _ []*types.Project) types.Check { return r.checkJSONCodec() },
	},
	{
		Name:     "sockets",
	...
	},
	{
		...
		NeedsWorkspace: true,
		run:            func(r *runner, _ []*types.Project) types.Check { return r.checkMCPClient() },
	},
	{
		Name:     "terminal-capabilities",
		Doc:      "what the terminal in front of magus can render",
		Evidence: types.EvidenceMeasured,
		run:      func(r *runner, _ []*types.Project) types.Check { return r.checkTerminal() },
	},
	{
		Name:     "workspace",
		Doc:      "the magusfile loads and its projects are discoverable",
		Evidence: types.EvidenceMeasured,
		run:      func(r *runner, projects []*types.Project) types.Check { return r.checkWorkspace(projects) },
	},
	{
		Name:           "config-file",
		...
		Evidence:       types.EvidenceMeasured,
		NeedsWorkspace: true,
		run:            func(r *runner, _ []*types.Project) types.Check { return r.checkConfigFile() },
	},
	{
		Name:           "cache-writable",
		...
		Evidence:       types.EvidenceMeasured,
		NeedsWorkspace: true,
		run:            func(r *runner, _ []*types.Project) types.Check { return r.checkCacheWritable() },
	},
	{
		...
		Evidence:       types.EvidenceMeasured,
		NeedsWorkspace: true,
		run:            func(r *runner, _ []*types.Project) types.Check { return r.checkConcurrencySizing() },
	},
	{
	...
	},
	{
		...
		Evidence:       types.EvidenceMeasured,
		NeedsWorkspace: true,
		run: func(r *runner, _ []*types.Project) types.Check {
	...
	},
	{
		...
		Evidence:       types.EvidenceMeasured,
		NeedsWorkspace: true,
		run:            func(r *runner, _ []*types.Project) types.Check { return r.checkSpellContract() },
	},
	{
		...
		Evidence:       types.EvidenceMeasured,
		NeedsWorkspace: true,
		run:            func(r *runner, _ []*types.Project) types.Check { return r.checkDiagnosticDocs() },
	},
	{
		...
		Evidence:       types.EvidenceInferred,
		NeedsWorkspace: true,
		run:            func(r *runner, _ []*types.Project) types.Check { return r.checkGraphCycles() },
	},
	{
	...
	},
	{
		...
		Evidence:       types.EvidenceMeasured,
		NeedsWorkspace: true,
		run:            func(r *runner, _ []*types.Project) types.Check { return r.checkOwedRegeneration() },
	},
	{
		Name:           "guard-binary",
	...
	},
	{
		...
		Evidence:       types.EvidenceMeasured,
		NeedsWorkspace: true,
		run:            func(r *runner, _ []*types.Project) types.Check { return r.checkObserverRecording() },
	},
	{
		Name:           "session-load",
		...
		Evidence:       types.EvidenceMeasured,
		NeedsWorkspace: true,
		run:            func(r *runner, _ []*types.Project) types.Check { return r.checkSessionLoad() },
	},
	{
		Name:           "guard-wiring",
		...
		Evidence:       types.EvidenceMeasured,
		NeedsWorkspace: true,
		run:            func(r *runner, _ []*types.Project) types.Check { return r.checkGuardWiring() },
	},
	{
		...
		Evidence:       types.EvidenceMeasured,
		NeedsWorkspace: true,
		run:            func(r *runner, _ []*types.Project) types.Check { return r.checkCheckpointWiring() },
	},
	{
		Name:           "bound-lease",
		...
		Evidence:       types.EvidenceMeasured,
		NeedsWorkspace: true,
		run:            func(r *runner, _ []*types.Project) types.Check { return r.checkBoundLease() },
	},
	{
		Name:           "job-tree",
	...
	},
	{
		...
		Evidence:       types.EvidenceMeasured,
		NeedsWorkspace: true,
		run:            func(r *runner, _ []*types.Project) types.Check { return r.checkAgentSkills() },
	},
	{
		Name:           "release-index",
	...
	},
	{
		...
		Evidence:       types.EvidenceMeasured,
		NeedsWorkspace: true,
		run:            func(r *runner, _ []*types.Project) types.Check { return r.checkSymlinks() },
	},
	{
		Name:           "graph-bounds",
		...
		Evidence:       types.EvidenceInferred,
		NeedsWorkspace: true,
		run:            func(r *runner, _ []*types.Project) types.Check { return r.checkGraphBounds() },
	},
	{
		...
		Evidence:       types.EvidenceMeasured,
		NeedsWorkspace: true,
		run:            func(r *runner, _ []*types.Project) types.Check { return r.checkGeneratedDrift() },
	},
	{
		...
		Evidence:       types.EvidenceMeasured,
		NeedsWorkspace: true,
		run:            func(r *runner, _ []*types.Project) types.Check { return r.checkStaleWorktrees() },
	},
	{
	...
	},
	{
		...
		Doc:            "a guard rule an agent hit repeatedly across sessions",
		Evidence:       types.EvidenceInferred,
		NeedsWorkspace: true,
		run:            func(r *runner, _ []*types.Project) types.Check { return r.checkRecurringGuardDenials() },
	},
	{
		Name:           "writes-without-rw-charm",
		Doc:            "a target with an rw branch that writes the tree outside it",
		Code:           types.WriteWithoutRWCharm,
		Evidence:       types.EvidenceInferred,
		NeedsWorkspace: true,
		run:            (*runner).checkWriteWithoutRWCharm,
	},
	{
		Name:           "source-is-also-output",
		Doc:            "one target declaring the same path as both a source and an output",
		Code:           types.SourceIsAlsoOutput,
		Evidence:       types.EvidenceDeclared,
		NeedsWorkspace: true,
	...
	},
	{
		...
		Evidence:       types.EvidenceMeasured,
		NeedsWorkspace: true,
		run:            func(r *runner, _ []*types.Project) types.Check { return r.checkVCSBaseRef() },
	},
	{
	...
	},
	{
		...
		Evidence:       types.EvidenceMeasured,
		NeedsWorkspace: true,
		run:            func(r *runner, _ []*types.Project) types.Check { return r.checkBridgeReachability() },
	},
}
