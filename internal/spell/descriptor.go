...
// magus-types-gen (the Go struct is the single source of truth) and must sit in
...
// magus-spells-gen), embedding the blob, and resolving its mgs_ functions at load
// time.
