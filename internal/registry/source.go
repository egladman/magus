...
// public/release/. Shipping a default is the same call already made for the update
// channel (selfupdate.DefaultDiscoveryURL): the endpoint is ours, it is documented,
// and overriding or declining it is one file.
//
