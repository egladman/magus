...
// the hosted Graph Explorer can read the current workspace. Maintenance jobs are not on this
// surface at all - they are submitted with `magus server job <name>`. Loopback only; bearer auth.
type Console struct {
