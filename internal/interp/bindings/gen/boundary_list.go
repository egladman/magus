...
var RuntimeBoundaryTypes = []BoundaryType{
	...
	{Name: "Artifact", Zero: types.TargetArtifact{}, Encode: func(v any) vm.Value { return ObjectTargetArtifact(v.(types.TargetArtifact)) }},
	{Name: "ArtifactVersion", Zero: types.ArtifactVersion{}, Encode: func(v any) vm.Value { return ObjectArtifactVersion(v.(types.ArtifactVersion)) }},
	...
	{Name: "CommandRequest", Zero: types.CommandRequest{}, Encode: func(v any) vm.Value { return ObjectCommandRequest(v.(types.CommandRequest)) }},
	...
	{Name: "Credential", Zero: types.Credential{}, Encode: func(v any) vm.Value { return ObjectCredential(v.(types.Credential)) }},
	...
	{Name: "Duplication", Zero: types.DuplicationOutput{}, Encode: func(v any) vm.Value { return ObjectDuplicationOutput(v.(types.DuplicationOutput)) }},
	...
	{Name: "Grant", Zero: types.Grant{}, Encode: func(v any) vm.Value { return ObjectGrant(v.(types.Grant)) }},
