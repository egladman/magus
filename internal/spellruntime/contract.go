...
var OptionalContract = []ContractEntry{
	...
	{Name: "mgs_listNamingDeviations", Field: "naming_deviations"},
	{Name: "mgs_listJSONCharmExceptions", Field: "json_charm_exceptions"},
	{Name: "mgs_listInstallHints", Field: "install_hints"},
	{Name: "mgs_getDocDescription", Field: "doc_description"},
	{Name: "mgs_getDocIntro", Field: "doc_intro"},
	{Name: "mgs_listDocTags", Field: "doc_tags"},
