...
var OptionalContract = []ContractEntry{
	...
	{Name: "mgs_getVersionProbe", Field: "version_cmd"},
	{Name: "mgs_getVersionProbes", Field: "version_cmds"},
	{Name: "mgs_getReadinessProbes", Field: "readiness_probes"},
	{Name: "mgs_getVersionKey", Field: "version_key"},
	{Name: "mgs_getVersionKeys", Field: "version_keys"},
