...
func TestStatusProtoMapsPool(t *testing.T) {
	...
	s := statusSnapshotToProto(t.Context(), r, types.BuildInfo{Version: "v1.2.3"})
...
func TestStatusProtoMapsCacheAndInv(t *testing.T) {
	...
	p := statusSnapshotToProto(t.Context(), r, types.BuildInfo{Version: "v1"}).GetPool()
	require.NotNil(t, p)
...
func TestStatusProtoHealth(t *testing.T) {
	assert.Equal(t, statusv1.Health_HEALTH_DOWN, statusSnapshotToProto(t.Context(), types.StatusSnapshot{}, types.BuildInfo{Version: "v1"}).GetHealth())
	assert.Equal(t, statusv1.Health_HEALTH_DEGRADED,
		statusSnapshotToProto(t.Context(), types.StatusSnapshot{Pool: &types.StatusOutput{}, PoolError: "boom"}, types.BuildInfo{Version: "v1"}).GetHealth())
}
...
func TestStatusProtoCarriesAFailedWorkspace(t *testing.T) {
	...
	s := statusSnapshotToProto(t.Context(), types.StatusSnapshot{Pool: &types.StatusOutput{Workspaces: []types.StatusWorkspace{
		{Root: "/ok"},
	...
	assert.True(t, proto.Equal(rpcerr.WorkspaceFailed("/repo", failure).Status(t.Context()), ws[2].GetError()))
}
...
func TestStatusProtoHealthMatchesReadiness(t *testing.T) {
	...
	for _, tc := range cases {
		t.Run(tc.name, func(t *testing.T) {
			s := statusSnapshotToProto(t.Context(), types.StatusSnapshot{Pool: &types.StatusOutput{Workspaces: tc.ws}}, types.BuildInfo{Version: "v1"})
...
func TestEncodeStatusEventRoundTrip(t *testing.T) {
	ev, err := EncodeStatusEvent(t.Context(), types.StatusSnapshot{Pool: &types.StatusOutput{Capacity: 4}}, types.BuildInfo{Version: "v1"})
...
func TestStatusProtoMapsRuns(t *testing.T) {
	...
	s := statusSnapshotToProto(t.Context(), r, types.BuildInfo{Version: "v1"})
...
func TestStatusProtoCarriesTheStaleLockThreshold(t *testing.T) {
	...
	locks := statusSnapshotToProto(t.Context(), r, types.BuildInfo{Version: "v1"}).GetLocks()
