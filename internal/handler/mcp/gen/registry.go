// Code generated by magus-utils mcptools. DO NOT EDIT.
//
// The MCP tool catalog, emitted from the std module descriptors. Edit the
// MCPTools declaration on the module (std/magus.go) and rerun
// `magus run mcp-tools-generate`, never this file.
...
var Registry = []ToolDescriptor{
	...
	},
	{
		...
		Params: []ParamDescriptor{
			...
			{Name: "read_only", Type: "boolean", Description: "put only: mark a lease that gathers evidence and writes nothing, so empty write and deny paths read as deliberate rather than forgotten."},
		},
	},
}
