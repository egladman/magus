...
var Registry = []ToolDescriptor{
	...
	},
	{
		...
		Params: []ParamDescriptor{
			...
			{Name: "write", Type: "boolean", Description: "true runs the script without --read-only, so it may write files and start processes. Omit it for a transform that must change nothing."},
		},
	},
	{
		Name:        "magus_doctor",
	...
	},
	{
		...
		Params: []ParamDescriptor{
			...
			{Name: "criteria", Type: "string", Description: "fork only: what the job is for and what done means, as prose. The machine-checkable half belongs in completion_gates, where it is graded rather than read."},
