...
var Registry = []ToolDescriptor{
	...
	{
		Name:        string(hint.ToolDescribeFile),
	...
	{
		Name:        string(hint.ToolAffectedExplain),
	...
	{
		Name:        string(hint.ToolRunTarget),
	...
	{
		Name:        string(hint.ToolRunAffected),
	...
	{
		Name:        string(hint.ToolAffectedPlan),
	...
	{
		Name:        string(hint.ToolVCSCheckpoint),
