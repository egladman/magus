...
var Registry = []ToolDescriptor{
	...
	},
	{
		...
		Params: []ParamDescriptor{
			{Name: "target", Type: "string", Required: true, Description: "Target to run, e.g. \"build\", \"test\", \"lint\", \"format\", \"ci\", or an op-direct spell-qualified form like \"golang::go-test\"."},
