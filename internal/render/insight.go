...
func writeInsightMarkdown(w io.Writer, r types.InsightReport, renderMermaid mermaidRenderer) error {
	var b md.Builder
	...
	if err := b.Fenced("mermaid", func(w io.Writer) error {
		return renderMermaid(w, hotspotGraphIR(r.Hotspots))
	}); err != nil {
		return err
	}
	...
	if len(r.Affinity.Pairs) > 0 {
		if err := b.Fenced("mermaid", func(w io.Writer) error {
			return renderMermaid(w, affinityGraphIR(r.Affinity))
		}); err != nil {
			return err
		}
