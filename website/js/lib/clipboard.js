...
// it now lives here once. Exported (was window.copyFeedback) and imported by the
// code-copy and anchors modules through the main.js bundle.
...
export function copyFeedback(opts) {
