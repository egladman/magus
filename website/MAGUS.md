...
This workspace has a knowledge graph of **521 nodes** and **644 edges** (schema v1). Query it instead of grepping:
...
| function | 208 | `magus query kind:function` | `site_render`, `renderPage`, `strLess` |
