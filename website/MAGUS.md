...
This workspace has a knowledge graph of **517 nodes** and **637 edges** (schema v1). Query it instead of grepping:
...
| function | 204 | `magus query kind:function` | `site_render`, `renderPage`, `strLess` |
