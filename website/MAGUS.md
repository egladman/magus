...
This workspace has a knowledge graph of **522 nodes** and **646 edges** (schema v1). Query it instead of grepping:
...
| function | 209 | `magus query kind:function` | `site_render`, `renderPage`, `strLess` |
