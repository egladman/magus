...
This workspace has a knowledge graph of **505 nodes** and **619 edges** (schema v1). Query it instead of grepping:
...
| function | 194 | `magus query kind:function` | `site_render`, `renderPage`, `strLess` |
