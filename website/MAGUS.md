...
This workspace has a knowledge graph of **512 nodes** and **634 edges** (schema v1). Query it instead of grepping:
...
| function | 201 | `magus query kind:function` | `site_render`, `renderPage`, `strLess` |
