...
This workspace has a knowledge graph of **1695 nodes** and **2979 edges** (schema v1). Query it instead of grepping:
...
| function | 983 | [`magus query kind:function`](https://eli.gladman.cc/magus/console/graph/#q=magus%20query%20kind:function) | `sel`, `site_render`, `sendObject` |
