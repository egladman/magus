...
> Generated by `magus run generate:rw .` (catalog `1cb30223b08447de`). Do not edit by hand.
...
| diagnostic | 60+ | `magus query kind:diagnostic` | `MGS2001`, `MGS1002`, `MGS3006` |
...
| dir | 100+ | `magus query kind:dir` | `libs/gopherbuzz/examples/bubblegum`, `docs/reference/codes/magusfile`, `std/examples/fs` |
