...
This workspace has a knowledge graph of **1690 nodes** and **2960 edges** (schema v1). Query it instead of grepping:
...
| function | 978 | [`magus query kind:function`](https://eli.gladman.cc/magus/graph/#q=magus%20query%20kind:function) | `sel`, `site_render`, `sendObject` |
