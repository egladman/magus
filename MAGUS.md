...
This workspace has a knowledge graph of **2129 nodes** and **4644 edges** (schema v6). Query it instead of grepping:
...
| function | 1092 | `magus query kind:function` | `sel`, `sendObject`, `send` |
