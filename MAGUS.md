...
This workspace has a knowledge graph of **2541 nodes** and **5010 edges** (schema v7). Query it instead of grepping:
...
| file | 221 | `magus query kind:file` | `libs/gopherbuzz/examples/bubblegum/config.buzz`, `magusfile.buzz`, `libs/gopherbuzz/examples/bubblegum/platform/macos/cocoa.buzz` |
| function | 1120 | `magus query kind:function` | `sel`, `sendObject`, `send` |
