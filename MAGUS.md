...
This workspace has a knowledge graph of **2341 nodes** and **5162 edges** (schema v7). Query it instead of grepping:
...
|---|--:|---|---|
| . | 31 | `magus query project:.` | `skills-generate`, `generate`, `lint` |
