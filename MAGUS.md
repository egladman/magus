...
This workspace has a knowledge graph of **2401 nodes** and **5413 edges** (schema v7). Query it instead of grepping:
...
|---|--:|---|---|
| . | 34 | `magus query project:.` | `generate`, `image-build`, `lint` |
