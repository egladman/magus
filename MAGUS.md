...
This workspace has a knowledge graph of **2407 nodes** and **5439 edges** (schema v7). Query it instead of grepping:
...
| method | 161 | `magus query kind:method` | `archive.compress`, `archive.uncompress`, `charm.after` |
