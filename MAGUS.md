...
| diagnostic | 61 | `magus query kind:diagnostic` | `MGS2001`, `MGS1002`, `MGS4001` |
| doc | 278 | `magus query kind:doc` | `docs/reference/manpage/magus-doctor.md`, `docs/reference/manpage/magus-affected.md`, `docs/concepts/spells.md` |
| dir | 136 | `magus query kind:dir` | `libs/gopherbuzz/examples/bubblegum`, `docs/reference/codes/magusfile`, `std/examples/fs` |
