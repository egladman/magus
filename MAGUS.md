...
| target | 95 | `magus query kind:target` | `content-generate`, `site-generate`, `image-build` |
...
| charm | 11 | `magus query kind:charm` | `rw`, `cd`, `stable` |
...
|---|--:|---|---|
| . | 35 | `magus query project:.` | `image-build`, `generate`, `lint` |
