...
This workspace has a knowledge graph of **2470 nodes** and **5596 edges** (schema v7). Query it instead of grepping:
...
| diagnostic | 55 | `magus query kind:diagnostic` | `MGS2001`, `MGS1022`, `MGS1002` |
| doc | 294 | `magus query kind:doc` | `docs/reference/manpage/magus-doctor.md`, `docs/reference/manpage/magus-affected.md`, `docs/reference/manpage/magus-run.md` |
