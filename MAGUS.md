...
This workspace has a knowledge graph of **2671 nodes** and **5781 edges** (schema v7). Query it instead of grepping:
...
| target | 93 | `magus query kind:target` | `content-generate`, `site-generate`, `skills-generate` |
...
| doc | 297 | `magus query kind:doc` | `docs/reference/manpage/magus-doctor.md`, `docs/reference/manpage/magus-affected.md`, `docs/reference/manpage/magus-run.md` |
| dir | 368 | `magus query kind:dir` | `libs/gopherbuzz/examples/bubblegum`, `std/examples/fs`, `docs/reference/buzz` |
...
|---|--:|---|---|
| . | 34 | `magus query project:.` | `skills-generate`, `bindings-generate`, `changelog-generate` |
