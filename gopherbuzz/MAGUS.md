...
This workspace has a knowledge graph of **969 nodes** and **1642 edges** (schema v6). Query it instead of grepping:
...
| doc | 8 | `magus query kind:doc` | `README.md`, `docs/ffi.md`, `examples/bubblegum/README.md` |
