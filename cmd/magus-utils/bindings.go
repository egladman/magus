...
// tags on the matching std/<name>.go files and with dry.WASMCompatibleHostModules
...
func emitBuzz(m std.Module) ([]byte, error) {
	...
	// only the pure-compute modules (dry.WASMCompatibleHostModules), which stay in
	// every build.
