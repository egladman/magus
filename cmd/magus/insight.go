...
func insightUsage() {
	...
	fmt.Fprintln(os.Stderr, "  report     all lenses as one Markdown doc (commit it as INSIGHT.md)")
	fmt.Fprintln(os.Stderr, "")
	fmt.Fprintln(os.Stderr, "Common flags: --commits N, --since 90d|12w|6mo|1y. Each lens accepts -o text|json|yaml|name.")
}
