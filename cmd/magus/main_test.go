...
func TestMain(m *testing.M) {
	...
	// testenv.Wrap clears the MAGUS_* configuration a job exports, and runs only in this
	// test process, never in a script's `exec magus`, whose environment is set on purpose.
