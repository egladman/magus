...
# magus-utils:subcommands:begin
    local subcommands="ls describe where run affected x clean shell query refs explain path graph diff vcs session memory job notes watch events server mcp status buzz agent init doctor config completion man self version help"
