...
# COMPREPLY=( $(compgen ...) ) is the bash-completion idiom, and word splitting
# is the point: compgen emits one candidate per line and COMPREPLY is an array.
# mapfile would work but is bash 4+, and this file targets bash 3.2 (macOS).
