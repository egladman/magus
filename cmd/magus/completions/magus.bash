...
# magus-utils:subcommands:begin
    local subcommands="ls describe run x where affected query explain path refs graph watch status clean vcs doctor config memory server buzz completion man init agent hook notify self version help"
