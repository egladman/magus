...
# magus-utils:subcommands:begin
    local subcommands="ls describe run x where affected query explain path refs graph watch status clean vcs doctor config activity attention memory notes diff server buzz completion man init agent hook notify self version help"
