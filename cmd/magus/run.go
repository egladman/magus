...
func targetUsage() error {
	...
	fmt.Fprintln(os.Stderr, "  export fun build(ctx: magus\\Context, args: [str]) > void { golang[\"go-build\"](ctx); }")
	...
	fmt.Fprintln(os.Stderr, "  magus run golang::go-vet /             # go-vet op of the golang spell across all projects")
	fmt.Fprintln(os.Stderr, "")
