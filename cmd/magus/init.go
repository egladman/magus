...
func printInitNextSteps(_ context.Context, cfgPath string, scaffolded, isLocal bool) {
	...
	interactive.Emit(os.Stderr, "  magus agent install .agents/skills                 # the Agent Skills themselves")
	interactive.Emit(os.Stderr, "  magus agent install-agents-md                     # the managed magus section in AGENTS.md")
