...
| a local skill (`magus-local`) | this workspace | YES - this is the layer |
...
```text
.claude/skills/magus-local/SKILL.md
```
...
3. Draft the rule into `magus-local` with `origin: agent, unreviewed`.
