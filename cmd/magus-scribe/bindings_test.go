...
// `magus-scribe bindings -lang buzz`. magus is excluded (hand-built in
// bindings/buzz.go). Unlike gen/js, charm is pure magus-scribe output here.
...
// are byte-for-byte identical to what `magus-scribe bindings -lang buzz` would emit today.
