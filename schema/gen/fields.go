...
func init() {
	Fields = []Field{
		...
		},
		{
			...
			Flag:     FlagNames{Long: "daemon-maintenance-rotate-activities"},
			Kind:     KindDuration,
		...
		},
		{
			...
			Flag:     FlagNames{Long: "daemon-maintenance-rotate-logs"},
			Kind:     KindDuration,
		...
		},
		{
			...
			Flag:     FlagNames{Long: "daemon-maintenance-sync-graph"},
			Kind:     KindDuration,
		...
		},
		{
			...
			Flag:     FlagNames{Long: "console-url"},
			Kind:     KindString,
