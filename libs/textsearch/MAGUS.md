...
This workspace has a knowledge graph of **2385 nodes** and **4673 edges** (schema v7). Query it instead of grepping:
...
| target | 93 | `magus query kind:target` | `skills-generate`, `site-generate`, `content-generate` |
...
| diagnostic | 54 | `magus query kind:diagnostic` | `MGS2001`, `MGS4001`, `MGS5002` |
| doc | 214 | `magus query kind:doc` | `docs/concepts/spells.md`, `docs/documentation.md`, `docs/concepts/cache.md` |
| dir | 167 | `magus query kind:dir` | `libs/gopherbuzz/examples/bubblegum`, `std/examples/fs`, `docs/tour` |
...
| function | 1209 | `magus query kind:function` | `sel`, `sendObject`, `send` |
...
| docs | 17 | `magus query project:docs` | `site-generate`, `content-generate`, `generate` |
