...
This workspace has a knowledge graph of **2562 nodes** and **5826 edges** (schema v7). Query it instead of grepping:
...
| doc | 278 | `magus query kind:doc` | `docs/concepts/spells.md`, `docs/reference/buzz/index.md`, `docs/documentation.md` |
...
| function | 1298 | `magus query kind:function` | `sel`, `sendObject`, `send` |
