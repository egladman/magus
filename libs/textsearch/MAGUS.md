...
This workspace has a knowledge graph of **310 nodes** and **301 edges** (schema v6). Query it instead of grepping:
...
| op | 53 | `magus query kind:op` | `shellcheck`, `buf-breaking`, `buf-build` |
