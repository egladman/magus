...
This workspace has a knowledge graph of **2646 nodes** and **5238 edges** (schema v7). Query it instead of grepping:
...
| dir | 449 | `magus query kind:dir` | `libs/gopherbuzz/examples/bubblegum`, `std/examples/fs`, `docs/reference/buzz` |
