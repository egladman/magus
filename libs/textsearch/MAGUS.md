...
This workspace has a knowledge graph of **2532 nodes** and **4991 edges** (schema v7). Query it instead of grepping:
...
| doc | 242 | `magus query kind:doc` | `docs/reference/manpage/magus-doctor.md`, `docs/reference/manpage/magus-affected.md`, `docs/reference/manpage/magus-run.md` |
