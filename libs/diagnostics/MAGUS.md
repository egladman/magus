...
This workspace has a knowledge graph of **2402 nodes** and **5413 edges** (schema v7). Query it instead of grepping:
...
| target | 92 | `magus query kind:target` | `content-generate`, `skills-generate`, `site-generate` |
