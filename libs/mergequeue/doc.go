...
//   - A [Lander] holds the write credential and executes no change's code. It lands each
...
// commit or the stage beneath it. The tip is the base branch's commit at landing, and a
