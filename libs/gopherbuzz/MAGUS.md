...
This workspace has a knowledge graph of **2523 nodes** and **5663 edges** (schema v7). Query it instead of grepping:
...
| function | 1267 | `magus query kind:function` | `sel`, `sendObject`, `send` |
