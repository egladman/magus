...
This workspace has a knowledge graph of **2474 nodes** and **5642 edges** (schema v7). Query it instead of grepping:
...
| spell | 12 | `magus query kind:spell` | `go`, `typescript`, `markdown` |
...
| doc | 249 | `magus query kind:doc` | `docs/concepts/spells.md`, `docs/reference/buzz/index.md`, `docs/documentation.md` |
