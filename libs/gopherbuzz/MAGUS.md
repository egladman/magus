...
This workspace has a knowledge graph of **2502 nodes** and **5753 edges** (schema v7). Query it instead of grepping:
...
| doc | 313 | `magus query kind:doc` | `docs/reference/manpage/magus-doctor.md`, `docs/reference/manpage/magus-run.md`, `docs/reference/manpage/magus-affected.md` |
