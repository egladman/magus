...
// the common suffix on TOKEN boundaries and emphasizes the span between them. That is exact
...
// A half-open [start, end) range of the line's text to emphasize.
...
//
// Both nulls means the two lines are identical, or differ so completely that emphasizing
// everything would be noise rather than signal - in either case the plain add/delete color
...
// a correspondence the patch does not contain - which would emphasize the wrong half of two
