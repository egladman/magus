  ...
  function buildMetrics(now: number, j: number): MetricsView {
    return {
      ...
      remote: {
        ...
        durationP50Seconds: 0.043,
        durationP95Seconds: 0.21,
        ioCount: 2276,
      ...
      buzz: {
        execCount: 8123 + j * 2,
        execP50Seconds: 0.0007,
        execP95Seconds: 0.004,
        compileCount: 412,
        compileP50Seconds: 0.0031,
        compileP95Seconds: 0.012,
        hostCallCount: 20_114,
        hostCallP50Seconds: 0.00002,
        hostCallP95Seconds: 0.0004,
        sessionPoolReuse: 3901,
        sessionPoolIdle: 6,
        sessionPoolEvictions: 42,
        sessionWarmP50Seconds: 0.0009,
        sessionWarmP95Seconds: 0.006,
        importCount: 733,
        importP50Seconds: 0.0004,
        importP95Seconds: 0.003,
        spellResolveCount: 1288,
        spellResolveP50Seconds: 0.0002,
        spellResolveP95Seconds: 0.0012,
        jitRuns: 61,
        vmFaults: 0,
      },
      sandbox: {
        applyP50Seconds: 0.0011,
        applyP95Seconds: 0.0068,
        rulesRead: 5120,
        rulesWrite: 880,
        rulesExec: 311,
        envRules: 96,
