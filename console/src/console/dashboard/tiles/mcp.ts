...
const columns: Column<McpToolView>[] = [
  ...
  },
  {
    ...
    label: "Dur p50",
    numeric: true,
    text: (r) => fmtDur(r.durationP50),
    sort: (r) => r.durationP50,
  },
  {
    key: "durP95",
    label: "Dur p95",
    numeric: true,
    text: (r) => fmtDur(r.durationP95),
    sort: (r) => r.durationP95,
  },
];
