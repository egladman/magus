...
export function buzzTile(): Tile {
  ...
  const grid = new MetricGrid([
    {
      ...
      items: [
        ...
        { key: "execP50", label: "exec p50" },
        { key: "execP95", label: "exec p95" },
        { key: "compileCount", label: "compile count" },
        { key: "compileP50", label: "compile p50" },
        { key: "compileP95", label: "compile p95" },
        { key: "hostCallCount", label: "host calls" },
        { key: "hostCallP50", label: "host p50" },
        { key: "hostCallP95", label: "host p95" },
      ],
    },
    {
    ...
    },
    {
      ...
      items: [
        ...
        { key: "importP50", label: "import p50" },
        { key: "importP95", label: "import p95" },
  ...
  function render(b: BuzzView): void {
    ...
    grid.set("execP50", fmtDur(b.execP50));
    grid.set("execP95", fmtDur(b.execP95));
    grid.set("compileCount", fmtCount(b.compileCount));
    grid.set("compileP50", fmtDur(b.compileP50));
    grid.set("compileP95", fmtDur(b.compileP95));
    grid.set("hostCallCount", fmtCount(b.hostCallCount));
    grid.set("hostCallP50", fmtDur(b.hostCallP50));
    grid.set("hostCallP95", fmtDur(b.hostCallP95));
    ...
    grid.set("warmP50", fmtDur(b.sessionWarmP50));
    grid.set("warmP95", fmtDur(b.sessionWarmP95));
    grid.set("importCount", fmtCount(b.importCount));
    grid.set("importP50", fmtDur(b.importP50));
    grid.set("importP95", fmtDur(b.importP95));
    grid.set("resolveCount", fmtCount(b.spellResolveCount));
    grid.set("resolveP50", fmtDur(b.spellResolveP50));
    grid.set("resolveP95", fmtDur(b.spellResolveP95));
