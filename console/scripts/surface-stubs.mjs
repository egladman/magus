...
// the server, and served one level deep at /console/<surface>/ those refs must resolve against
...
// serveConsoleShell injection exactly. Keep SURFACES in step with the server's KnownSurfaces
// (internal/service/console) and the console's CLEAN_PATH_SURFACES.
import { readFileSync, writeFileSync, mkdirSync } from "node:fs";

const SURFACES = ["logs", "dashboard", "graph", "activity", "notes", "diff", "plan", "runs"];
