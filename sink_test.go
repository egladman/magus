...
func TestTextSinkProse(t *testing.T) {
	...
	for _, c := range []struct {
		...
		{report.RunRemote{}, "remote: 0 restored, 0 missed, 0 published, 0 failed (0 B down, 0 B up)\n"},
		{report.RunRemote{Hits: 1, Misses: 2, Published: 3, DownBytes: 2048}, "remote: 1 restored, 2 missed, 3 published, 0 failed (2.0 KiB down, 0 B up)\n"},
