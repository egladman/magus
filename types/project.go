...
type Project struct {
	...
	// TargetDerives are per-target ctx.derive overrides, canonical sorted strings, folded
	// into the cache key. See TargetGraphNode.Derives.
	TargetDerives map[string][]string
