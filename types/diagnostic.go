...
const (
	...
	// PipeCycle is a run whose standard input is written, through a chain of magus
	// processes, by itself. Each would wait for the one before it to settle its locks,
