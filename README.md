...
the wire contracts are the [`libs/proto/magus`](https://github.com/egladman/magus/tree/main/libs/proto/magus)
protobufs.
...
response types are the [`libs/proto/magus`](https://github.com/egladman/magus/tree/main/libs/proto/magus)
