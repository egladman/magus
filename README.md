...
<!-- Grid layout after cathrynlavery/diagram-design's README gallery. Screenshots are
     regenerated by ./hacks/screenshots.sh against each surface's #demo showcase. The last row
     is the same console on a phone (375x812, device emulation on) - a different design rather
     than the same one squeezed, and with the larger touch targets that come with it. -->
<table>
  <tr>
