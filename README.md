...
<!-- Grid layout after cathrynlavery/diagram-design's README gallery. Screenshots are
     regenerated by ./hacks/screenshots.sh against each surface's #demo showcase. The last
     row is the same console below its 48rem breakpoint, where the layout is a different
     design rather than the same one squeezed. -->
<table>
  <tr>
  ...
  <tr>
    <td align="center" width="33%"><img src="./assets/screenshots/console-diff-narrow.png" alt="Diff on a narrow viewport"><br><b>Diff, narrow</b><br><sub>The file index folds to a rail; split view falls back to unified</sub></td>
    <td align="center" width="33%"><img src="./assets/screenshots/console-logs-narrow.png" alt="Log Viewer on a narrow viewport"><br><b>Log Viewer, narrow</b><br><sub>The waterfall keeps its drawn size and scrolls, rather than shrinking its labels away</sub></td>
    <td align="center" width="33%"><img src="./assets/screenshots/console-dashboard-narrow.png" alt="Dashboard on a narrow viewport"><br><b>Dashboard, narrow</b><br><sub>Tiles stack; the navigation rail gives way to the launcher grid</sub></td>
  </tr>
</table>
