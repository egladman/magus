...
This workspace has a knowledge graph of **2459 nodes** and **5616 edges** (schema v7). Query it instead of grepping:
...
| doc | 279 | `magus query kind:doc` | `docs/concepts/spells.md`, `docs/reference/buzz/index.md`, `docs/documentation.md` |
| dir | 145 | `magus query kind:dir` | `libs/gopherbuzz/examples/bubblegum`, `std/examples/fs`, `docs/reference/buzz` |
...
| function | 1240 | `magus query kind:function` | `sel`, `sendObject`, `send` |
