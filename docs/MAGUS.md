...
This workspace has a knowledge graph of **747 nodes** and **1903 edges** (schema v6). Query it instead of grepping:
...
| doc | 141 | `magus query kind:doc` | `documentation.md`, `spells.md`, `manpage/magus-affected.md` |
