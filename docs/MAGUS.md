...
| spell      | built in | `magus query kind=spell`      | `go`, `typescript`, `markdown`                                                                                              |
| op         | built in | `magus query kind=op`         | `go-build`, `go-test`, `go-fmt`                                                                                             |
| tool       | built in | `magus query kind=tool`       | `go`, `pnpm`, `cargo`                                                                                                       |
...
| libs/textsearch                 |       6 | `magus query project=libs/textsearch`                 | `preflight`, `lint`, `test`                              |
...
| `preflight`               | preflight installs node_modules through the typescript spell's install.                                                                                                                                                                                                                                                                                                                                                        |
