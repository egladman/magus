...
This workspace has a knowledge graph of **2451 nodes** and **5549 edges** (schema v7). Query it instead of grepping:
...
| file | 229 | `magus query kind:file` | `magusfile.buzz`, `libs/gopherbuzz/examples/bubblegum/config.buzz`, `libs/gopherbuzz/examples/bubblegum/platform/macos/cocoa.buzz` |
| function | 1196 | `magus query kind:function` | `sel`, `sendObject`, `send` |
