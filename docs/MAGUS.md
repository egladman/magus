...
This workspace has a knowledge graph of **2199 nodes** and **4863 edges** (schema v6). Query it instead of grepping:
...
| doc | 225 | `magus query kind:doc` | `docs/reference/manpage/magus-affected.md`, `docs/reference/manpage/magus-doctor.md`, `docs/reference/manpage/magus-run.md` |
