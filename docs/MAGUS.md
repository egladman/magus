...
This workspace has a knowledge graph of **2407 nodes** and **5423 edges** (schema v7). Query it instead of grepping:
...
|---|--:|---|---|
| . | 34 | `magus query project:.` | `skills-generate`, `generate`, `lint` |
