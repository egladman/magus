...
This workspace has a knowledge graph of **2084 nodes** and **4525 edges** (schema v6). Query it instead of grepping:
...
| target | 79 | `magus query kind:target` | `content-generate`, `generate`, `generate` |
| spell | 12 | `magus query kind:spell` | `go`, `ts`, `docker` |
...
| doc | 187 | `magus query kind:doc` | `docs/reference/manpage/magus-doctor.md`, `docs/reference/manpage/magus-run.md`, `docs/concepts/spells.md` |
| dir | 96 | `magus query kind:dir` | `libs/gopherbuzz/examples/bubblegum`, `std/examples/fs`, `docs/reference/buzz` |
...
| import | 113 | `magus query kind:import` | `std`, `magus`, `fs` |
...
| libs/diag | 8 | `magus query project:libs/diag` | `format`, `generate`, `build` |
...
| proto | 3 | `magus query project:proto` | `ci`, `generate`, `lint` |
