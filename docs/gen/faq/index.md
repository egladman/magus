...
by default with `default_charms: [rw]`. See [charms.md](charms.md#the-rw-charm).
...
ci` is the monorepo CI workhorse. See [affected.md](affected.md).
...
it with `MAGUS_DAEMON_ENABLED=false`. See [daemon.md](daemon.md).
...
[spells.md](spells.md) and the [authoring editor setup](editor.md).
...
[charms.md](charms.md#stacking-and-composition).
...
surface; a target is the normal way in. See [operations.md](operations.md).
...
stop plan. See [charms.md](charms.md#previewing-the-rendered-command).
...
- [getting-started.md](getting-started.md) - the first ten minutes.
