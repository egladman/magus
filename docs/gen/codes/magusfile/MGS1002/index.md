...
[the workspace model](../../workspace.md)). That rule is deliberate: a spell name
...
- [workspace.md](../../workspace.md): how spell imports resolve, root-wins, across a nested workspace.
- [spells.md](../../spells.md): authoring a spell and binding it to a project.
