...
> **Naming convention:** Buzz reaches modules off the `import "magus/extra"` aggregate in `camelCase` (`extra.archive.someMethod`).
...
**Signature:** `extra.archive.uncompress(src, dest, [opts]) → map[string]any`
...
**Signature:** `extra.archive.compress(src, dest, [opts]) → map[string]any`
