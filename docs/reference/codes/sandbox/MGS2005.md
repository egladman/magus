...
- [sandbox diagnostics](README.md): the rest of the `MGS2xxx` range.
- [Sandbox model](../../../concepts/sandbox.md): the kernel and interpreter
  enforcement layers, and what the interpreter-only fallback still covers.
