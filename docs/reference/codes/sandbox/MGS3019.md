---
title: "MGS3019: a hook names no agent host"
...
tags: [MGS3019, guard, hooks, agents, harness, agent-name]
---

# MGS3019: a hook names no agent host
...
```text
[MGS3019] this hook did not pass --agent-name, so magus cannot tell which agent
