...
fails for a different reason (e.g. [MGS2001](MGS2001.md) on the same path),
you have a clear chain to follow.

## See also

- [sandbox diagnostics](README.md): the rest of the `MGS2xxx` range.
- [Sandbox model](../../../concepts/sandbox.md): how `sandbox.allow` entries
  become filesystem rules.
