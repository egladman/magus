...
- [magusfile diagnostics](README.md): the rest of the `MGS1xxx` range.
- [Dependencies](../../../concepts/dependencies.md): `depends_on` and the
  cross-project relationship a workspace-local `replace` mirrors.
