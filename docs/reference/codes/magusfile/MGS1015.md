...
```text
[MGS1015] docs: target "ci": ctx.needs names a target in
...
import "project/guides/integrations/agents";  // -> docs/guides/integrations/agents
import "project/../libs/textsearch";           // -> libs/textsearch
```
