...
description: A daemon route under /api/ was asked with an HTTP method it does not serve, answered 405 with the methods it does serve in Allow.
tags: [MGS9012, auth, api, http, "405"]
---

# MGS9012: method not allowed

The daemon answered `405 method not allowed` because the route does not serve
