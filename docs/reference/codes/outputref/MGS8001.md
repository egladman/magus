...
- [output-reference diagnostics](README.md): the rest of the `MGS8xxx` range.
- [Output refs](../../../concepts/cache/output-refs.md): how a ref is minted
  and how long the store keeps it.
