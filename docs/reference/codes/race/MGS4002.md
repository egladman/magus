...
- [Concurrency](../../../concepts/concurrency.md): the parallel-dispatch model
  that makes declared-output overlap a real hazard.
- [MGS4001](MGS4001.md): runtime filesystem race detector (requires `--race`).
