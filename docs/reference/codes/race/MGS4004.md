...
- [MGS4001](MGS4001.md): runtime race detector that this check builds on.
- [Dependencies](../../../concepts/dependencies.md): the declared edges this
  audit checks the build against.
