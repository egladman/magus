...
- [knowledge-graph diagnostics](README.md): the rest of the `MGS7xxx` range.
- [Knowledge graph](../../../concepts/knowledge.md): the deterministic graph
  this extraction step builds, and what an inferred edge means.
