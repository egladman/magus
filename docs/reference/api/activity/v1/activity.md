...
Package `magus.activity.v1`, defined in `proto/magus/activity/v1/activity.proto`. Source: [activity.proto:120](https://github.com/egladman/magus/blob/main/proto/magus/activity/v1/activity.proto#L120). Part of the [daemon API](../../index.md).
...
`POST /magus.activity.v1.ActivityService/ListActivity`: unary. Source: [activity.proto:122](https://github.com/egladman/magus/blob/main/proto/magus/activity/v1/activity.proto#L122).

Takes [ListActivityRequest](#listactivityrequest), returns [ListActivityResponse](#listactivityresponse).

### GetPayload

GetPayload returns a stored request or response body by its ref (from an ActivityEvent).

`POST /magus.activity.v1.ActivityService/GetPayload`: unary. Source: [activity.proto:124](https://github.com/egladman/magus/blob/main/proto/magus/activity/v1/activity.proto#L124).

Takes [GetPayloadRequest](#getpayloadrequest), returns [GetPayloadResponse](#getpayloadresponse).
...
Source: [activity.proto:73](https://github.com/egladman/magus/blob/main/proto/magus/activity/v1/activity.proto#L73).
...
Used by: [ListActivity (response)](activity.md#listactivity).
...
Source: [activity.proto:129](https://github.com/egladman/magus/blob/main/proto/magus/activity/v1/activity.proto#L129).
...
| `time` | [TimeRange](../../query/v1/query.md#timerange) | 4 | action-time window |

Used by: [ListActivity (request)](activity.md#listactivity).

### GetPayloadRequest

Source: [activity.proto:146](https://github.com/egladman/magus/blob/main/proto/magus/activity/v1/activity.proto#L146).
...
Source: [activity.proto:150](https://github.com/egladman/magus/blob/main/proto/magus/activity/v1/activity.proto#L150).
...
Source: [activity.proto:136](https://github.com/egladman/magus/blob/main/proto/magus/activity/v1/activity.proto#L136).
...
Source: [activity.proto:141](https://github.com/egladman/magus/blob/main/proto/magus/activity/v1/activity.proto#L141).
...
Source: [activity.proto:23](https://github.com/egladman/magus/blob/main/proto/magus/activity/v1/activity.proto#L23).
...
Used by: [ListActivity (request)](activity.md#listactivity), [ListActivity (response)](activity.md#listactivity).

### Outcome

Outcome is how the action ended.

Source: [activity.proto:59](https://github.com/egladman/magus/blob/main/proto/magus/activity/v1/activity.proto#L59).
