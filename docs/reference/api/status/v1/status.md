...
Package `magus.status.v1`, defined in `proto/magus/status/v1/status.proto`. Source: [status.proto:179](https://github.com/egladman/magus/blob/main/proto/magus/status/v1/status.proto#L179). Part of the [daemon API](../../index.md).
...
`POST /magus.status.v1.StatusService/GetStatus`: unary. Source: [status.proto:181](https://github.com/egladman/magus/blob/main/proto/magus/status/v1/status.proto#L181).
...
`POST /magus.status.v1.StatusService/StreamStatus`: server streaming. Source: [status.proto:184](https://github.com/egladman/magus/blob/main/proto/magus/status/v1/status.proto#L184).
...
Source: [status.proto:68](https://github.com/egladman/magus/blob/main/proto/magus/status/v1/status.proto#L68).
...
Source: [status.proto:170](https://github.com/egladman/magus/blob/main/proto/magus/status/v1/status.proto#L170).
...
Source: [status.proto:201](https://github.com/egladman/magus/blob/main/proto/magus/status/v1/status.proto#L201).
...
Source: [status.proto:187](https://github.com/egladman/magus/blob/main/proto/magus/status/v1/status.proto#L187).
...
Source: [status.proto:188](https://github.com/egladman/magus/blob/main/proto/magus/status/v1/status.proto#L188).
...
| `config` | [Config](#config) | 3 | the daemon's resolved, read-only configuration |
...
Source: [status.proto:56](https://github.com/egladman/magus/blob/main/proto/magus/status/v1/status.proto#L56).
...
Source: [status.proto:128](https://github.com/egladman/magus/blob/main/proto/magus/status/v1/status.proto#L128).
...
Source: [status.proto:79](https://github.com/egladman/magus/blob/main/proto/magus/status/v1/status.proto#L79).
...
Source: [status.proto:142](https://github.com/egladman/magus/blob/main/proto/magus/status/v1/status.proto#L142).
...
Source: [status.proto:117](https://github.com/egladman/magus/blob/main/proto/magus/status/v1/status.proto#L117).
...
Source: [status.proto:23](https://github.com/egladman/magus/blob/main/proto/magus/status/v1/status.proto#L23).

| Field | Type | # | Description |
|-------|------|---|-------------|
| `health` | [Health](#health) | 1 |  |
| `pool` | [Pool](#pool) | 2 | live concurrency; absent when no daemon/pool is running |
| `runs` | [repeated Run](#run) | 4 | runs the daemon is executing right now (adopted dispatches) |
| `services` | [repeated Service](#service) | 5 | long-running shared services the daemon is hosting right now |
| `build` | [BuildInfo](#buildinfo) | 6 | the running daemon's build identity |
...
Source: [status.proto:206](https://github.com/egladman/magus/blob/main/proto/magus/status/v1/status.proto#L206).
...
Source: [status.proto:207](https://github.com/egladman/magus/blob/main/proto/magus/status/v1/status.proto#L207).
...
Source: [status.proto:89](https://github.com/egladman/magus/blob/main/proto/magus/status/v1/status.proto#L89).
...
Source: [status.proto:151](https://github.com/egladman/magus/blob/main/proto/magus/status/v1/status.proto#L151).
...
Source: [status.proto:15](https://github.com/egladman/magus/blob/main/proto/magus/status/v1/status.proto#L15).
...
Source: [status.proto:97](https://github.com/egladman/magus/blob/main/proto/magus/status/v1/status.proto#L97).
