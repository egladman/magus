...
**Signature:** `math\round(x, [places]) → float64` · [source](https://github.com/egladman/magus/blob/main/std/math.go#L101)
...
**Signature:** `math\trunc(x) → float64` · [source](https://github.com/egladman/magus/blob/main/std/math.go#L117)
...
**Signature:** `math\clamp(x, lo, hi) → float64` · [source](https://github.com/egladman/magus/blob/main/std/math.go#L120)
...
**Signature:** `math\sum(nums) → float64` · [source](https://github.com/egladman/magus/blob/main/std/math.go#L128)
...
**Signature:** `math\mean(nums) → float64` · [source](https://github.com/egladman/magus/blob/main/std/math.go#L146)
...
**Signature:** `math\median(nums) → float64` · [source](https://github.com/egladman/magus/blob/main/std/math.go#L156)
...
**Signature:** `math\min(nums) → float64` · [source](https://github.com/egladman/magus/blob/main/std/math.go#L172)
...
**Signature:** `math\max(nums) → float64` · [source](https://github.com/egladman/magus/blob/main/std/math.go#L184)
