...
**Signature:** `uuid\v4() -> string` - [source](https://github.com/egladman/magus/blob/main/std/uuid.go#L61)
...
**Signature:** `uuid\v7() -> string` - [source](https://github.com/egladman/magus/blob/main/std/uuid.go#L70)
