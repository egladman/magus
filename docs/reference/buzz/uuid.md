...
**Signature:** `uuid\v4() → string` · [source](https://github.com/egladman/magus/blob/main/std/uuid.go#L60)
...
**Signature:** `uuid\v7() → string` · [source](https://github.com/egladman/magus/blob/main/std/uuid.go#L69)
...
**Signature:** `uuid\randomHex(n) → string` · [source](https://github.com/egladman/magus/blob/main/std/uuid.go#L78)
...
**Signature:** `uuid\randomToken(n) → string` · [source](https://github.com/egladman/magus/blob/main/std/uuid.go#L90)
