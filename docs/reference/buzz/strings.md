...
**Signature:** `strings\camelCase(s) → string` · [source](https://github.com/egladman/magus/blob/main/std/strings.go#L174)
...
**Signature:** `strings\snakeCase(s) → string` · [source](https://github.com/egladman/magus/blob/main/std/strings.go#L179)
...
**Signature:** `strings\kebabCase(s) → string` · [source](https://github.com/egladman/magus/blob/main/std/strings.go#L184)
...
**Signature:** `strings\pascalCase(s) → string` · [source](https://github.com/egladman/magus/blob/main/std/strings.go#L189)
...
**Signature:** `strings\capitalize(s) → string` · [source](https://github.com/egladman/magus/blob/main/std/strings.go#L194)
...
**Signature:** `strings\words(s) → []string` · [source](https://github.com/egladman/magus/blob/main/std/strings.go#L199)
...
**Signature:** `strings\ellipsis(s, length) → string` · [source](https://github.com/egladman/magus/blob/main/std/strings.go#L204)
...
**Signature:** `strings\upperFirst(s) → string` · [source](https://github.com/egladman/magus/blob/main/std/strings.go#L209)
...
**Signature:** `strings\compare(a, b) → int` · [source](https://github.com/egladman/magus/blob/main/std/strings.go#L219)
...
**Signature:** `strings\contains(s, substr) → bool` · [source](https://github.com/egladman/magus/blob/main/std/strings.go#L224)
...
**Signature:** `strings\trimPrefix(s, prefix) → string` · [source](https://github.com/egladman/magus/blob/main/std/strings.go#L229)
...
**Signature:** `strings\trimSuffix(s, suffix) → string` · [source](https://github.com/egladman/magus/blob/main/std/strings.go#L234)
...
**Signature:** `strings\padLeft(s, length, [pad]) → string` · [source](https://github.com/egladman/magus/blob/main/std/strings.go#L239)
...
**Signature:** `strings\padRight(s, length, [pad]) → string` · [source](https://github.com/egladman/magus/blob/main/std/strings.go#L245)
...
**Signature:** `strings\lines(s) → []string` · [source](https://github.com/egladman/magus/blob/main/std/strings.go#L273)
...
**Signature:** `strings\fields(s) → []string` · [source](https://github.com/egladman/magus/blob/main/std/strings.go#L286)
...
**Signature:** `strings\splitN(s, sep, n) → []string` · [source](https://github.com/egladman/magus/blob/main/std/strings.go#L295)
...
**Signature:** `strings\collapseWs(s) → string` · [source](https://github.com/egladman/magus/blob/main/std/strings.go#L304)
