...
**Signature:** `toml\parse(source) → any` · [source](https://github.com/egladman/magus/blob/main/std/toml.go#L42)
...
**Signature:** `toml\stringify(value) → string` · [source](https://github.com/egladman/magus/blob/main/std/toml.go#L51)
