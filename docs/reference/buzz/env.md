...
**Signature:** `env\get(name) → string`[^buzz-stdlib-env-get] · [source](https://github.com/egladman/magus/blob/main/std/env.go#L117)
...
**Signature:** `env\lookup(name) → string, bool`[^buzz-stdlib-env-lookup] · [source](https://github.com/egladman/magus/blob/main/std/env.go#L132)
...
**Signature:** `env\set(name, value)` · [source](https://github.com/egladman/magus/blob/main/std/env.go#L141)
...
**Signature:** `env\list() → map[string]string` · [source](https://github.com/egladman/magus/blob/main/std/env.go#L222)
...
**Signature:** `env\unset(name)` · [source](https://github.com/egladman/magus/blob/main/std/env.go#L158)
...
**Signature:** `env\expand(s) → string` · [source](https://github.com/egladman/magus/blob/main/std/env.go#L173)
...
**Signature:** `env\home() → string` · [source](https://github.com/egladman/magus/blob/main/std/env.go#L184)
...
**Signature:** `env\getOr(name, def) → string` · [source](https://github.com/egladman/magus/blob/main/std/env.go#L195)
...
**Signature:** `env\require(name) → string` · [source](https://github.com/egladman/magus/blob/main/std/env.go#L210)
...
**Signature:** `env\parseDotenv(content) → map[string]string` · [source](https://github.com/egladman/magus/blob/main/std/env.go#L243)
...
**Signature:** `env\loadDotenv(path)` · [source](https://github.com/egladman/magus/blob/main/std/env.go#L263)
