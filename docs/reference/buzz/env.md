...
**Signature:** `env\get(name) -> string`[^buzz-stdlib-env-get] - [source](https://github.com/egladman/magus/blob/main/std/env.go#L119)
...
**Signature:** `env\lookup(name) -> string, bool`[^buzz-stdlib-env-lookup] - [source](https://github.com/egladman/magus/blob/main/std/env.go#L135)
...
Set name to value for this run: its later reads and the processes it starts see it, other runs in the same magus process do not.

**Signature:** `env\set(name, value)` - [source](https://github.com/egladman/magus/blob/main/std/env.go#L155)
...
**Signature:** `env\list() -> map[string]string` - [source](https://github.com/egladman/magus/blob/main/std/env.go#L241)

**Returns:** map[string]string

### unset

Remove name for this run, the counterpart of set.

**Signature:** `env\unset(name)` - [source](https://github.com/egladman/magus/blob/main/std/env.go#L172)
...
**Signature:** `env\expand(s) -> string` - [source](https://github.com/egladman/magus/blob/main/std/env.go#L191)
...
**Signature:** `env\home() -> string` - [source](https://github.com/egladman/magus/blob/main/std/env.go#L203)
...
**Signature:** `env\getOr(name, def) -> string` - [source](https://github.com/egladman/magus/blob/main/std/env.go#L214)
...
**Signature:** `env\require(name) -> string` - [source](https://github.com/egladman/magus/blob/main/std/env.go#L229)
...
**Signature:** `env\parseDotenv(content) -> map[string]string` - [source](https://github.com/egladman/magus/blob/main/std/env.go#L262)
...
**Signature:** `env\readDotenv(path) -> map[string]string` - [source](https://github.com/egladman/magus/blob/main/std/env.go#L267)
...
Read a .env file and set each variable for this run, as set does, without overwriting names already set (the dotenv convention) or names the sandbox strips. A no-op in a recording/dry-run.

**Signature:** `env\loadDotenv(path)` - [source](https://github.com/egladman/magus/blob/main/std/env.go#L282)
