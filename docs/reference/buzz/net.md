...
**Signature:** `net\waitForPort(host, port, [timeout_ms]) → bool` · [source](https://github.com/egladman/magus/blob/main/std/net.go#L121)
...
**Signature:** `net\isPortOpen(host, port) → bool` · [source](https://github.com/egladman/magus/blob/main/std/net.go#L95)
...
**Signature:** `net\freePort() → int` · [source](https://github.com/egladman/magus/blob/main/std/net.go#L160)
