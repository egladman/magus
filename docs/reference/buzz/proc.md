...
**Signature:** `proc\exec(cmd, [args], [dir], [opts]) → ExecResult` · [source](https://github.com/egladman/magus/blob/main/std/os.go#L358)
...
**Signature:** `proc\shell(line, [shell]) → ShellCommand` · [source](https://github.com/egladman/magus/blob/main/std/os.go#L380)
...
**Signature:** `proc\withSlots(n, callback)` · [source](https://github.com/egladman/magus/blob/main/std/os.go#L500)
...
**Signature:** `proc\stdinIsTerminal() → bool` · [source](https://github.com/egladman/magus/blob/main/std/os.go#L180)
