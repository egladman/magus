...
**Signature:** `proc\which(cmd) -> string` - [source](https://github.com/egladman/magus/blob/main/std/os.go#L193)
...
**Signature:** `proc\stdinIsTerminal() -> bool` - [source](https://github.com/egladman/magus/blob/main/std/os.go#L179)
