...
**Signature:** `fs\exists(path) → bool`[^buzz-stdlib-fs-exists] · [source](https://github.com/egladman/magus/blob/main/std/fs.go#L313)
...
**Signature:** `fs\readFile(path) → string` · [source](https://github.com/egladman/magus/blob/main/std/fs.go#L333)
...
**Signature:** `fs\writeFile(path, content)` · [source](https://github.com/egladman/magus/blob/main/std/fs.go#L346)
...
**Signature:** `fs\mkdirall(path, [perm])`[^buzz-stdlib-fs-mkdirall] · [source](https://github.com/egladman/magus/blob/main/std/fs.go#L361)
...
**Signature:** `fs\join(parts...) → string` · [source](https://github.com/egladman/magus/blob/main/std/fs.go#L376)
...
**Signature:** `fs\removeAll(path)`[^buzz-stdlib-fs-remove_all] · [source](https://github.com/egladman/magus/blob/main/std/fs.go#L381)
...
**Signature:** `fs\remove(path)` · [source](https://github.com/egladman/magus/blob/main/std/fs.go#L397)
...
**Signature:** `fs\rename(src, dst)` · [source](https://github.com/egladman/magus/blob/main/std/fs.go#L414)
...
**Signature:** `fs\size(path) → int` · [source](https://github.com/egladman/magus/blob/main/std/fs.go#L439)
...
**Signature:** `fs\tempFile([prefix]) → string` · [source](https://github.com/egladman/magus/blob/main/std/fs.go#L452)
...
**Signature:** `fs\writeFileAtomic(path, content)` · [source](https://github.com/egladman/magus/blob/main/std/fs.go#L471)
...
**Signature:** `fs\listDir(path) → []string`[^buzz-stdlib-fs-list_dir] · [source](https://github.com/egladman/magus/blob/main/std/fs.go#L524)
...
**Signature:** `fs\ext(path) → string` · [source](https://github.com/egladman/magus/blob/main/std/fs.go#L544)
...
**Signature:** `fs\isDir(path) → bool` · [source](https://github.com/egladman/magus/blob/main/std/fs.go#L550)
...
**Signature:** `fs\isFile(path) → bool` · [source](https://github.com/egladman/magus/blob/main/std/fs.go#L561)
...
**Signature:** `fs\stat(path) → FileInfo` · [source](https://github.com/egladman/magus/blob/main/std/fs.go#L573)
...
**Signature:** `fs\copyFile(src, dst)` · [source](https://github.com/egladman/magus/blob/main/std/fs.go#L592)
...
**Signature:** `fs\copyDir(src, dst)` · [source](https://github.com/egladman/magus/blob/main/std/fs.go#L612)
...
**Signature:** `fs\watch(paths, callback)` · [source](https://github.com/egladman/magus/blob/main/std/fs.go#L710)
...
**Signature:** `fs\walk(root, callback)` · [source](https://github.com/egladman/magus/blob/main/std/fs.go#L767)
...
**Signature:** `fs\appendFile(path, content)` · [source](https://github.com/egladman/magus/blob/main/std/fs.go#L804)
...
**Signature:** `fs\chmod(path, mode)` · [source](https://github.com/egladman/magus/blob/main/std/fs.go#L827)
...
**Signature:** `fs\symlink(target, link)` · [source](https://github.com/egladman/magus/blob/main/std/fs.go#L843)
...
**Signature:** `fs\readlink(path) → string` · [source](https://github.com/egladman/magus/blob/main/std/fs.go#L861)
...
**Signature:** `fs\tempDir([prefix]) → string` · [source](https://github.com/egladman/magus/blob/main/std/fs.go#L904)
...
**Signature:** `fs\readLines(path) → []string` · [source](https://github.com/egladman/magus/blob/main/std/fs.go#L877)
...
**Signature:** `fs\writeLines(path, lines)` · [source](https://github.com/egladman/magus/blob/main/std/fs.go#L891)
