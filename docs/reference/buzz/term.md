...
**Signature:** `term\isInteractive() → bool` · [source](https://github.com/egladman/magus/blob/main/std/term.go#L118)
...
**Signature:** `term\wantsColor() → bool` · [source](https://github.com/egladman/magus/blob/main/std/term.go#L123)
...
**Signature:** `term\size() → TermSize` · [source](https://github.com/egladman/magus/blob/main/std/term.go#L128)
...
**Signature:** `term\colorize(s, style) → string` · [source](https://github.com/egladman/magus/blob/main/std/term.go#L143)
...
**Signature:** `term\pick(items, [prompt], [initial_filter], [initial], [max_rows]) → int` · [source](https://github.com/egladman/magus/blob/main/std/term.go#L151)
...
**Signature:** `term\notify(message, [level], [ttl_ms])` · [source](https://github.com/egladman/magus/blob/main/std/term.go#L200)
...
**Signature:** `term\clearScreen()` · [source](https://github.com/egladman/magus/blob/main/std/term.go#L251)
