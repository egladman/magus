...
**Signature:** `sort\strings(items) → []string` · [source](https://github.com/egladman/magus/blob/main/std/sort.go#L57)
...
**Signature:** `sort\natural(items) → []string` · [source](https://github.com/egladman/magus/blob/main/std/sort.go#L64)
...
**Signature:** `sort\semver(items) → []string` · [source](https://github.com/egladman/magus/blob/main/std/sort.go#L123)
