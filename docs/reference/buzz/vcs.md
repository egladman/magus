...
**Signature:** `vcs\name() → string` · [source](https://github.com/egladman/magus/blob/main/std/vcs.go#L171)
...
**Signature:** `vcs\base() → string` · [source](https://github.com/egladman/magus/blob/main/std/vcs.go#L180)
...
**Signature:** `vcs\changedFiles([base]) → [Path]` · [source](https://github.com/egladman/magus/blob/main/std/vcs.go#L210)
...
**Signature:** `vcs\ref() → string` · [source](https://github.com/egladman/magus/blob/main/std/vcs.go#L283)
...
**Signature:** `vcs\status([paths]) → Status` · [source](https://github.com/egladman/magus/blob/main/std/vcs.go#L304)
...
**Signature:** `vcs\isDirty([paths]) → bool` · [source](https://github.com/egladman/magus/blob/main/std/vcs.go#L335)
...
**Signature:** `vcs\dirtyDiff([paths]) → string` · [source](https://github.com/egladman/magus/blob/main/std/vcs.go#L364)
...
**Signature:** `vcs\commit([rev]) → Commit` · [source](https://github.com/egladman/magus/blob/main/std/vcs.go#L384)
...
**Signature:** `vcs\history([limit]) → [Commit]` · [source](https://github.com/egladman/magus/blob/main/std/vcs.go#L403)
...
**Signature:** `vcs\cmd(args, [opts]) → ExecResult` · [source](https://github.com/egladman/magus/blob/main/std/vcs.go#L471)
...
**Signature:** `vcs\tags([pattern]) → [Tag]` · [source](https://github.com/egladman/magus/blob/main/std/vcs.go#L433)
...
**Signature:** `vcs\describe() → string` · [source](https://github.com/egladman/magus/blob/main/std/vcs.go#L419)
