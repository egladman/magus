...
**Signature:** `vcs\shortHash() → string` · [source](https://github.com/egladman/magus/blob/main/std/vcs.go#L239)
...
**Signature:** `vcs\hash() → string` · [source](https://github.com/egladman/magus/blob/main/std/vcs.go#L248)
...
**Signature:** `vcs\branch() → string` · [source](https://github.com/egladman/magus/blob/main/std/vcs.go#L257)
...
**Signature:** `vcs\commitDate() → string` · [source](https://github.com/egladman/magus/blob/main/std/vcs.go#L266)
...
**Signature:** `vcs\isDirty([paths]) → bool` · [source](https://github.com/egladman/magus/blob/main/std/vcs.go#L348)
...
**Signature:** `vcs\diagnoseDrift(outputs, [inputs]) → map[string]any` · [source](https://github.com/egladman/magus/blob/main/std/vcs.go#L297)
...
**Signature:** `vcs\metadata() → map[string]any` · [source](https://github.com/egladman/magus/blob/main/std/vcs.go#L374)
...
**Signature:** `vcs\commit([rev]) → Commit` · [source](https://github.com/egladman/magus/blob/main/std/vcs.go#L402)
...
**Signature:** `vcs\history([limit]) → [Commit]` · [source](https://github.com/egladman/magus/blob/main/std/vcs.go#L420)
...
**Signature:** `vcs\exe() → string` · [source](https://github.com/egladman/magus/blob/main/std/vcs.go#L467)
...
**Signature:** `vcs\tags([pattern]) → [Tag]` · [source](https://github.com/egladman/magus/blob/main/std/vcs.go#L450)
...
**Signature:** `vcs\describe() → string` · [source](https://github.com/egladman/magus/blob/main/std/vcs.go#L436)
