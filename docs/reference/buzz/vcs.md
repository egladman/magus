...
**Signature:** `vcs\root() → string` · [source](https://github.com/egladman/magus/blob/main/std/vcs.go#L187)
...
**Signature:** `vcs\diff([base]) → []string` · [source](https://github.com/egladman/magus/blob/main/std/vcs.go#L200)
...
**Signature:** `vcs\shortHash() → string` · [source](https://github.com/egladman/magus/blob/main/std/vcs.go#L240)
...
**Signature:** `vcs\hash() → string` · [source](https://github.com/egladman/magus/blob/main/std/vcs.go#L249)
...
**Signature:** `vcs\branch() → string` · [source](https://github.com/egladman/magus/blob/main/std/vcs.go#L258)
...
**Signature:** `vcs\commitDate() → string` · [source](https://github.com/egladman/magus/blob/main/std/vcs.go#L267)
...
**Signature:** `vcs\isDirty([paths]) → bool` · [source](https://github.com/egladman/magus/blob/main/std/vcs.go#L343)
...
**Signature:** `vcs\diagnoseDrift(outputs, [inputs]) → map[string]any` · [source](https://github.com/egladman/magus/blob/main/std/vcs.go#L298)
...
**Signature:** `vcs\metadata() → map[string]any` · [source](https://github.com/egladman/magus/blob/main/std/vcs.go#L363)
...
**Signature:** `vcs\commit([rev]) → Commit` · [source](https://github.com/egladman/magus/blob/main/std/vcs.go#L391)
...
**Signature:** `vcs\history([limit]) → [Commit]` · [source](https://github.com/egladman/magus/blob/main/std/vcs.go#L409)
...
**Signature:** `vcs\exe() → string` · [source](https://github.com/egladman/magus/blob/main/std/vcs.go#L456)
...
**Signature:** `vcs\tags([pattern]) → [Tag]` · [source](https://github.com/egladman/magus/blob/main/std/vcs.go#L439)
...
**Signature:** `vcs\describe() → string` · [source](https://github.com/egladman/magus/blob/main/std/vcs.go#L425)
