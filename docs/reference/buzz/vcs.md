...
**Signature:** `vcs\isDirty([paths]) → bool` · [source](https://github.com/egladman/magus/blob/main/std/vcs.go#L349)
...
**Signature:** `vcs\metadata() → map[string]any` · [source](https://github.com/egladman/magus/blob/main/std/vcs.go#L375)
...
**Signature:** `vcs\commit([rev]) → Commit` · [source](https://github.com/egladman/magus/blob/main/std/vcs.go#L403)
...
**Signature:** `vcs\history([limit]) → [Commit]` · [source](https://github.com/egladman/magus/blob/main/std/vcs.go#L421)
...
**Signature:** `vcs\exe() → string` · [source](https://github.com/egladman/magus/blob/main/std/vcs.go#L468)
...
**Signature:** `vcs\tags([pattern]) → [Tag]` · [source](https://github.com/egladman/magus/blob/main/std/vcs.go#L451)
...
**Signature:** `vcs\describe() → string` · [source](https://github.com/egladman/magus/blob/main/std/vcs.go#L437)
