...
**Signature:** `log\trace(message, [attrs])` · [source](https://github.com/egladman/magus/blob/main/std/log.go#L102)
...
**Signature:** `log\debug(message, [attrs])` · [source](https://github.com/egladman/magus/blob/main/std/log.go#L107)
...
**Signature:** `log\info(message, [attrs])` · [source](https://github.com/egladman/magus/blob/main/std/log.go#L112)
...
**Signature:** `log\warn(message, [attrs])` · [source](https://github.com/egladman/magus/blob/main/std/log.go#L117)
...
**Signature:** `log\error(message, [attrs])` · [source](https://github.com/egladman/magus/blob/main/std/log.go#L122)
...
**Signature:** `log\at(level, message, [attrs])` · [source](https://github.com/egladman/magus/blob/main/std/log.go#L127)
