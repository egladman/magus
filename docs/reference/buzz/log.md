...
**Signature:** `log\trace(message, [attrs])` - [source](https://github.com/egladman/magus/blob/main/std/log.go#L98)
...
**Signature:** `log\debug(message, [attrs])` - [source](https://github.com/egladman/magus/blob/main/std/log.go#L103)
...
**Signature:** `log\info(message, [attrs])` - [source](https://github.com/egladman/magus/blob/main/std/log.go#L108)
...
**Signature:** `log\warn(message, [attrs])` - [source](https://github.com/egladman/magus/blob/main/std/log.go#L113)
...
**Signature:** `log\error(message, [attrs])` - [source](https://github.com/egladman/magus/blob/main/std/log.go#L118)
...
**Signature:** `log\at(level, message, [attrs])` - [source](https://github.com/egladman/magus/blob/main/std/log.go#L123)
