...
**Signature:** `url\encode(s) → string` · [source](https://github.com/egladman/magus/blob/main/std/url.go#L60)
...
**Signature:** `url\decode(s) → string` · [source](https://github.com/egladman/magus/blob/main/std/url.go#L65)
...
**Signature:** `url\parse(raw_url) → URL` · [source](https://github.com/egladman/magus/blob/main/std/url.go#L74)
...
**Signature:** `url\build(parts) → string` · [source](https://github.com/egladman/magus/blob/main/std/url.go#L91)
