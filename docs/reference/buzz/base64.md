...
**Signature:** `base64\encode(data) → string` · [source](https://github.com/egladman/magus/blob/main/std/encoding/base64/base64.go#L70)
...
**Signature:** `base64\decode(s) → string` · [source](https://github.com/egladman/magus/blob/main/std/encoding/base64/base64.go#L75)
...
**Signature:** `base64\urlEncode(data) → string` · [source](https://github.com/egladman/magus/blob/main/std/encoding/base64/base64.go#L84)
...
**Signature:** `base64\urlDecode(s) → string` · [source](https://github.com/egladman/magus/blob/main/std/encoding/base64/base64.go#L89)
