...
**Signature:** `platform\arch(name, [style]) → string` · [source](https://github.com/egladman/magus/blob/main/std/platform.go#L221)
...
**Signature:** `platform\os(name, [style]) → string` · [source](https://github.com/egladman/magus/blob/main/std/platform.go#L231)
...
**Signature:** `platform\memoryBytes() → int` · [source](https://github.com/egladman/magus/blob/main/std/platform.go#L140)
