...
**Signature:** `path\abs(path) → string` · [source](https://github.com/egladman/magus/blob/main/std/path.go#L86)
...
**Signature:** `path\rel(base, target) → string` · [source](https://github.com/egladman/magus/blob/main/std/path.go#L95)
...
**Signature:** `path\clean(path) → string` · [source](https://github.com/egladman/magus/blob/main/std/path.go#L104)
...
**Signature:** `path\isAbs(path) → bool` · [source](https://github.com/egladman/magus/blob/main/std/path.go#L136)
...
**Signature:** `path\matches(pattern, path) → bool` · [source](https://github.com/egladman/magus/blob/main/std/path.go#L113)
...
**Signature:** `path\matchesAny(patterns, path) → bool` · [source](https://github.com/egladman/magus/blob/main/std/path.go#L122)
...
**Signature:** `path\expandUser(path) → string` · [source](https://github.com/egladman/magus/blob/main/std/path.go#L143)
