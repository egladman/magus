...
**Signature:** `archive\uncompress(src, dest, [opts]) → UncompressResult` · [source](https://github.com/egladman/magus/blob/main/std/archive.go#L401)
...
**Signature:** `archive\compress(src, dest, [opts]) → CompressResult` · [source](https://github.com/egladman/magus/blob/main/std/archive.go#L470)
...
**Signature:** `archive\list(src, [opts]) → [ArchiveEntry]` · [source](https://github.com/egladman/magus/blob/main/std/archive.go#L189)
...
**Signature:** `archive\readFile(src, name, [opts]) → string` · [source](https://github.com/egladman/magus/blob/main/std/archive.go#L270)
