...
**Signature:** `archive\uncompress(src, dest, [opts]) → UncompressResult` · [source](https://github.com/egladman/magus/blob/main/std/archive.go#L393)
...
**Signature:** `archive\compress(src, dest, [opts]) → CompressResult` · [source](https://github.com/egladman/magus/blob/main/std/archive.go#L462)
