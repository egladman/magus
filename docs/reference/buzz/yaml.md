...
**Signature:** `yaml\parse(source) → any` · [source](https://github.com/egladman/magus/blob/main/std/yaml.go#L40)
...
**Signature:** `yaml\stringify(value) → string` · [source](https://github.com/egladman/magus/blob/main/std/yaml.go#L49)
