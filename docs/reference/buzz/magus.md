...
**Signature:** `magus\cmd(sub, args, [opts]) -> ExecResult` - [source](https://github.com/egladman/magus/blob/main/std/magus.go#L1124)
...
**Signature:** `magus\projects() -> Projects` - [source](https://github.com/egladman/magus/blob/main/std/magus.go#L969)
...
**Signature:** `magus\targets([opts]) -> TargetGraph` - [source](https://github.com/egladman/magus/blob/main/std/magus.go#L988)
...
**Signature:** `magus\affected([base]) -> Affected` - [source](https://github.com/egladman/magus/blob/main/std/magus.go#L1002)
...
**Signature:** `magus\projectGraph() -> Graph` - [source](https://github.com/egladman/magus/blob/main/std/magus.go#L1106)
...
**Signature:** `magus\where(dir) -> string` - [source](https://github.com/egladman/magus/blob/main/std/magus.go#L1017)
...
**Signature:** `magus\raise(code, message, [opts])` - [source](https://github.com/egladman/magus/blob/main/std/magus.go#L1045)
...
**Signature:** `magus\run(args, [opts]) -> ExecResult` - [source](https://github.com/egladman/magus/blob/main/std/magus.go#L1141)
...
**Signature:** `magus\describe(args, [opts]) -> ExecResult` - [source](https://github.com/egladman/magus/blob/main/std/magus.go#L1146)
...
**Signature:** `magus\insight([opts]) -> InsightReport` - [source](https://github.com/egladman/magus/blob/main/std/magus.go#L1186)
...
**Signature:** `magus\affectedImpact([base], [opts]) -> Impact` - [source](https://github.com/egladman/magus/blob/main/std/magus.go#L1169)
...
**Signature:** `magus\describeFile(paths, [opts]) -> FileReport` - [source](https://github.com/egladman/magus/blob/main/std/magus.go#L1514)
...
**Signature:** `magus\diff([opts]) -> Diff` - [source](https://github.com/egladman/magus/blob/main/std/magus.go#L1531)
...
**Signature:** `magus\doctor(args, [opts]) -> DoctorReport` - [source](https://github.com/egladman/magus/blob/main/std/magus.go#L1162)
...
**Signature:** `magus\attention(args, [opts]) -> map[string]any` - [source](https://github.com/egladman/magus/blob/main/std/magus.go#L1153)
...
**Signature:** `magus\diagnoseDrift(outputs, [inputs]) -> DriftResult` - [source](https://github.com/egladman/magus/blob/main/std/magus.go#L1755)
...
**Signature:** `magus\bustCache([project_path])` - [source](https://github.com/egladman/magus/blob/main/std/magus.go#L929)
...
**Signature:** `magus\hasCharm(name) -> bool` - [source](https://github.com/egladman/magus/blob/main/std/magus.go#L922)
