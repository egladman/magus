...
**Signature:** `magus\cmd(sub, args, [opts]) → ExecResult` · [source](https://github.com/egladman/magus/blob/main/std/magus.go#L613)
...
**Signature:** `magus\ls() → Projects` · [source](https://github.com/egladman/magus/blob/main/std/magus.go#L458)
...
**Signature:** `magus\targets([opts]) → TargetGraph` · [source](https://github.com/egladman/magus/blob/main/std/magus.go#L477)
...
**Signature:** `magus\affected([base]) → Affected` · [source](https://github.com/egladman/magus/blob/main/std/magus.go#L491)
...
**Signature:** `magus\projectGraph() → Graph` · [source](https://github.com/egladman/magus/blob/main/std/magus.go#L595)
...
**Signature:** `magus\where(dir) → string` · [source](https://github.com/egladman/magus/blob/main/std/magus.go#L506)
...
**Signature:** `magus\raise(code, message, [opts])` · [source](https://github.com/egladman/magus/blob/main/std/magus.go#L534)
...
**Signature:** `magus\run(args, [opts]) → ExecResult` · [source](https://github.com/egladman/magus/blob/main/std/magus.go#L630)
...
**Signature:** `magus\describe(args, [opts]) → ExecResult` · [source](https://github.com/egladman/magus/blob/main/std/magus.go#L635)
...
**Signature:** `magus\insight([opts]) → InsightReport` · [source](https://github.com/egladman/magus/blob/main/std/magus.go#L668)
...
**Signature:** `magus\insightMarkdown([opts]) → string` · [source](https://github.com/egladman/magus/blob/main/std/magus.go#L686)
...
**Signature:** `magus\affectedImpact([base], [opts]) → Impact` · [source](https://github.com/egladman/magus/blob/main/std/magus.go#L651)
...
**Signature:** `magus\describeFile(paths, [opts]) → FileReport` · [source](https://github.com/egladman/magus/blob/main/std/magus.go#L810)
...
**Signature:** `magus\doctor(args, [opts]) → DoctorReport` · [source](https://github.com/egladman/magus/blob/main/std/magus.go#L644)
...
**Signature:** `magus\diagnoseDrift(outputs, [inputs]) → DriftResult` · [source](https://github.com/egladman/magus/blob/main/std/magus.go#L987)
