...
**Signature:** `magus\cmd(sub, args, [opts]) → ExecResult` · [source](https://github.com/egladman/magus/blob/main/std/magus.go#L586)
...
**Signature:** `magus\ls() → Projects` · [source](https://github.com/egladman/magus/blob/main/std/magus.go#L433)
...
**Signature:** `magus\targets() → TargetGraph` · [source](https://github.com/egladman/magus/blob/main/std/magus.go#L445)
...
**Signature:** `magus\affected([base]) → Affected` · [source](https://github.com/egladman/magus/blob/main/std/magus.go#L460)
...
**Signature:** `magus\graph() → Graph` · [source](https://github.com/egladman/magus/blob/main/std/magus.go#L568)
...
**Signature:** `magus\where(dir) → string` · [source](https://github.com/egladman/magus/blob/main/std/magus.go#L475)
...
**Signature:** `magus\raise(code, message, [opts])` · [source](https://github.com/egladman/magus/blob/main/std/magus.go#L507)
...
**Signature:** `magus\run(args, [opts]) → ExecResult` · [source](https://github.com/egladman/magus/blob/main/std/magus.go#L603)
...
**Signature:** `magus\describe(args, [opts]) → ExecResult` · [source](https://github.com/egladman/magus/blob/main/std/magus.go#L608)
...
**Signature:** `magus\insight(args, [opts]) → ExecResult` · [source](https://github.com/egladman/magus/blob/main/std/magus.go#L613)
...
**Signature:** `magus\insightReport(args, [opts]) → InsightReport` · [source](https://github.com/egladman/magus/blob/main/std/magus.go#L646)
...
**Signature:** `magus\affectedImpact([base], [opts]) → Impact` · [source](https://github.com/egladman/magus/blob/main/std/magus.go#L629)
...
**Signature:** `magus\targetGraph([opts]) → TargetGraph` · [source](https://github.com/egladman/magus/blob/main/std/magus.go#L639)
...
**Signature:** `magus\describeFile(paths, [opts]) → FileReport` · [source](https://github.com/egladman/magus/blob/main/std/magus.go#L654)
...
**Signature:** `magus\doctor(args, [opts]) → DoctorReport` · [source](https://github.com/egladman/magus/blob/main/std/magus.go#L622)
...
**Signature:** `magus\diagnoseDrift(outputs, [inputs]) → DriftResult` · [source](https://github.com/egladman/magus/blob/main/std/magus.go#L834)
...
**Signature:** `magus\bustCache([project_path])` · [source](https://github.com/egladman/magus/blob/main/std/magus.go#L389)
...
**Signature:** `magus\has_charm(name) → bool` · [source](https://github.com/egladman/magus/blob/main/std/magus.go#L382)
...
The canonical form of a magus entity name - a target, charm, or spell op. Returns the NAME, never a spell handle.

**Signature:** `magus\normalize(name) → string`
...
Log at info level. The only way to log from a magusfile; there is no separate log module on this surface.

**Signature:** `magus\info([msg], [fields])`
...
Log at debug level. See magus.info.

**Signature:** `magus\debug([msg], [fields])`
...
Log at warn level. See magus.info.

**Signature:** `magus\warn([msg], [fields])`
...
Log at error level. See magus.info. Logging an error does not abort; magus.fatal does.

**Signature:** `magus\error([msg], [fields])`
...
Emit an advisory nudge: non-fatal, deduped, and suppressed when hints are toggled off.

**Signature:** `magus\hint([msg])`
