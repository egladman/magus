...
**Signature:** `xml\render(node) → string` · [source](https://github.com/egladman/magus/blob/main/std/encoding/xml/xml.go#L80)
...
**Signature:** `xml\element(tag, attrs, children) → any` · [source](https://github.com/egladman/magus/blob/main/std/encoding/xml/xml.go#L67)
...
**Signature:** `xml\parse(s) → any` · [source](https://github.com/egladman/magus/blob/main/std/encoding/xml/xml.go#L138)
