...
**Signature:** `ini\parse(source) → map[string]map[string]string` · [source](https://github.com/egladman/magus/blob/main/std/encoding/ini/ini.go#L73)
...
**Signature:** `ini\stringify(sections) → string` · [source](https://github.com/egladman/magus/blob/main/std/encoding/ini/ini.go#L123)
