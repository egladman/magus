...
| [push-ungated](push-ungated.md)               | a push at a commit the run log records no green gate for                                          |
| [raw-tool](raw-tool.md)                       | a toolchain command a spell already wraps, run outside the cache                                  |
| [read-ack](read-ack.md)                       | an agent stamping a read receipt, which records that a PERSON read a change                       |
...
| [push-gate](push-gate.md)               | a push with no gate run since the last change                                |
