...
**--hook** *hook*
: Run as the git \`hook\` named, once the operation has the whole tree: regenerate what it changed and stage the result; wired by the merge driver's registration, not run by hand
