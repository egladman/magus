...
**--all**
: Print all matching paths to stdout; do not error on ambiguity

**--filter** *string*
: Restrict file search by pattern. Form: type=\<glob|regex|literal\>,pattern=\<value\>

**--glob** *string*
: Restrict file search to paths matching a doublestar glob (shorthand for --filter type=glob,...)

**--literal** *string*
: Restrict file search to paths containing this exact segment (shorthand for --filter type=literal,...)

**--regex** *string*
: Restrict file search to paths matching a Go regexp (shorthand for --filter type=regex,...)
