...
<header>
<input type="radio" name="magus-run-variant" id="magus-run-tab-short" checked>
<label for="magus-run-tab-short">Short form</label>
<input type="radio" name="magus-run-variant" id="magus-run-tab-full">
<label for="magus-run-tab-full">Full form</label>
</header>
