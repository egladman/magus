...
<div class="grid landing-cards">
  ...
  <a class="landing-card" href="magus-workspace-rules/"><span class="landing-card-title">magus-workspace-rules</span><span class="landing-card-body">Adapt magus's installed agent surface to THIS workspace without breaking it.</span><span class="landing-card-body"><small>8.3 KB short, 10.3 KB full - 19% shorter</small></span></a>
</div>

All 15 together are 131.3 KB installed as the short form, against 170.1 KB for the full twins: 22% less always-loaded text.
