...
| [magus-change-summary](magus-change-summary.md) | 5133 | 3911 | 23% | Summarize what changed in a magus workspace, write it up, or answer a granular diff question. |
...
| [magus-delegate-multi-agent](magus-delegate-multi-agent.md) | 12204 | 9134 | 25% | Split work across agents in a magus workspace as an acceptance-criteria loop: partition by WRITE SET using graph evidence (magus refs --occurrences, explain, affected --plan --stdin), prove the units cannot collide, bound fan-out depth, and match each unit's model to the work it needs. |
