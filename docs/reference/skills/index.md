...
| [magus-buzz](magus-buzz.md) | 8161 | 6763 | 17% | Write and run Buzz, the language magusfiles, spells, and `magus buzz` scripts are written in. |
| [magus-buzz-review](magus-buzz-review.md) | 20249 | 15125 | 25% | Review Buzz code - a magusfile, a spell, or a standalone .buzz script - across three lenses run in parallel: idiom/style, skeptic/correctness, and upstream-Buzz conformance. |
| [magus-changes](magus-changes.md) | 5137 | 3916 | 23% | Summarize what changed in a magus workspace, write it up, or answer a granular diff question. |
