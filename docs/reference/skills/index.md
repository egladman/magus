...
<div class="grid landing-cards">
  ...
  <a class="landing-card" href="magus-run/"><span class="landing-card-title">magus-run</span><span class="landing-card-body">Run builds, tests, lints, and codegen through magus targets.</span><span class="landing-card-body"><small>7.3 KB short, 11.1 KB full - 34% shorter</small></span></a>
...
All 15 together are 111.5 KB installed as the short form, against 144.5 KB for the full twins: 22% less always-loaded text.
