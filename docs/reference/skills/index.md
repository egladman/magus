...
<div class="grid landing-cards">
  ...
  <a class="landing-card" href="magus-workspace-rules/"><span class="landing-card-title">magus-workspace-rules</span><span class="landing-card-body">Adapt magus's installed agent surface to THIS workspace without breaking it.</span><span class="landing-card-body"><small>8.4 KB short, 10.5 KB full - 19% shorter</small></span></a>
</div>

All 15 together are 131.4 KB installed as the short form, against 170.3 KB for the full twins: 22% less always-loaded text.
