...
| [magus-sdk](magus-sdk.md) | 13286 | 12620 | 5% | Help a Go developer consume magus as a library (import "github.com/egladman/magus") instead of shelling out to the CLI, and audit whether the SDK actually serves them. |
| [magus-vcs](magus-vcs.md) | 5402 | 3443 | 36% | Safe git operations in a magus workspace (any repo with magusfile.buzz at the root). |
| **all 10** | **64689** | **49684** | **23%** | |
