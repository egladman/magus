...
| [magus-buzz](magus-buzz.md) | 8159 | 6761 | 17% | Write and run Buzz, the language magusfiles, spells, and `magus buzz` scripts are written in. |
| [magus-buzz-review](magus-buzz-review.md) | 17483 | 13661 | 21% | Review Buzz code - a magusfile, a spell, or a standalone .buzz script - across three lenses run in parallel: idiom/style, skeptic/correctness, and upstream-Buzz conformance. |
