...
| [magus-query](magus-query.md) | 12745 | 10313 | 19% | Query the magus knowledge graph to find and relate entities (projects, targets, spells, ops, charms, modules, diagnostics, docs). |
