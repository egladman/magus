...
<div class="grid landing-cards">
  ...
  <a class="landing-card" href="magus-workspace-rules/"><span class="landing-card-title">magus-workspace-rules</span><span class="landing-card-body">Adapt magus's installed agent surface to THIS workspace without breaking it.</span><span class="landing-card-body"><small>5.3 KB short, 6.3 KB full - 15% shorter</small></span></a>
</div>

All 15 together are 117.3 KB installed as the short form, against 152.8 KB for the full twins: 23% less always-loaded text.
