...
| [magus-run](magus-run.md) | 9020 | 5249 | 41% | Run builds, tests, lints, and codegen through magus targets. |
...
| [magus-vcs](magus-vcs.md) | 6977 | 4541 | 34% | Safe git operations in a magus workspace (any repo with magusfile.buzz at the root). |
| **all 11** | **75872** | **58347** | **23%** | |
