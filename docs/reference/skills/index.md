...
<div class="grid landing-cards">
  ...
  <a class="landing-card" href="magus-run/"><span class="landing-card-title">magus-run</span><span class="landing-card-body">Run builds, tests, lints, and codegen through magus targets.</span><span class="landing-card-body"><small>7.7 KB short, 11.5 KB full - 33% shorter</small></span></a>
  ...
  <a class="landing-card" href="magus-workspace-rules/"><span class="landing-card-title">magus-workspace-rules</span><span class="landing-card-body">Adapt magus's installed agent surface to THIS workspace without breaking it.</span><span class="landing-card-body"><small>7.6 KB short, 9.0 KB full - 15% shorter</small></span></a>
</div>

All 15 together are 120.8 KB installed as the short form, against 156.8 KB for the full twins: 22% less always-loaded text.
