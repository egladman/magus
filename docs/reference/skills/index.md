...
<div class="grid landing-cards">
  ...
  <a class="landing-card" href="magus-run/"><span class="landing-card-title">magus-run</span><span class="landing-card-body">Run builds, tests, lints, and codegen through magus targets.</span><span class="landing-card-body"><small>8.3 KB short, 12.4 KB full - 33% shorter</small></span></a>
...
All 15 together are 131.4 KB installed as the short form, against 170.2 KB for the full twins: 22% less always-loaded text.
