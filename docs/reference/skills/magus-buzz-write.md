...
<header>
<input type="radio" name="magus-buzz-write-variant" id="magus-buzz-write-tab-short" checked>
<label for="magus-buzz-write-tab-short">Short form</label>
<input type="radio" name="magus-buzz-write-variant" id="magus-buzz-write-tab-full">
<label for="magus-buzz-write-tab-full">Full form</label>
</header>
