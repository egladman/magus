...
<header>
<input type="radio" name="magus-memory-variant" id="magus-memory-tab-short" checked>
<label for="magus-memory-tab-short">Short form</label>
<input type="radio" name="magus-memory-variant" id="magus-memory-tab-full">
<label for="magus-memory-tab-full">Full form</label>
</header>
