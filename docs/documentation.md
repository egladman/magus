...
- [Merge queue](concepts/merge-queue.md) - the separate `mergequeue` library and CLI: queue a pull request by enabling auto-merge, validate stages speculatively, land each as its own commit; magus supplies the affected sets.
