...
- [Merge queue](concepts/merge-queue.md) - queue a pull request by enabling auto-merge; `magus vcs queue` validates the queue speculatively and lands each change as its own commit.
