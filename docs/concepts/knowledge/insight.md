...
change together, who owns what. The [man page](../../reference/manpage/magus-insight.md) lists
...
- **report** - every lens, plus the knowledge graph's shape from
  ...
  for tools that render it. The magusfile's postflight target prints this to
