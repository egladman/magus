...
|-------|----------|-----|---------|
| [`bash`](spells/bash.md) | Shell | 3 | Bash spell: shellcheck linting, shfmt formatting, and bats tests for shell scripts. |
| [`buf`](spells/buf.md) | Protobuf | 7 | Buf spell: protobuf build, lint, format, and code generation. |
| [`buzz`](spells/buzz.md) | Buzz | 3 | Buzz spell: check and test .buzz sources, plus run them through the magus interpreter. |
| [`cosign`](spells/cosign.md) | - | 6 | Cosign spell: sign, attest, verify, verify-attestation, and the blob pair for artifacts and images. |
| [`docker`](spells/docker.md) | Docker | 8 | Docker spell: image build, build-check, buildx, hadolint linting, and trivy/scout image scanning. |
| [`go`](spells/go.md) | Go | 14 | Go toolchain spell: build, test, vet, fmt, gofumpt, mod-tidy, golangci-lint, and govulncheck as magus ops. |
