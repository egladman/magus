...
// An explicit default server host (host:port) to connect to when the URL carries no #live / no
// remembered server - the "loopback URL override" (implicit 127.0.0.1 otherwise). "" means unset.
