...
**Signature:** `uuid.v4() → string` · [source](https://github.com/egladman/magus/blob/main/std/uuid.go#L56)
...
**Signature:** `uuid.v7() → string` · [source](https://github.com/egladman/magus/blob/main/std/uuid.go#L65)
...
**Signature:** `uuid.randomHex(n) → string` · [source](https://github.com/egladman/magus/blob/main/std/uuid.go#L74)
...
**Signature:** `uuid.randomToken(n) → string` · [source](https://github.com/egladman/magus/blob/main/std/uuid.go#L86)
