...
**Signature:** `archive.uncompress(src, dest, [opts]) → map[string]any` · [source](https://github.com/egladman/magus/blob/main/std/archive.go#L112)
...
**Signature:** `archive.compress(src, dest, [opts]) → map[string]any` · [source](https://github.com/egladman/magus/blob/main/std/archive.go#L184)
