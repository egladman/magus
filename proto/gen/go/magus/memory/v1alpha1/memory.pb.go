...
func (MemoryType) Descriptor() protoreflect.EnumDescriptor {
	return file_magus_memory_v1alpha1_memory_proto_enumTypes[0].Descriptor()
}

func (MemoryType) Type() protoreflect.EnumType {
	return &file_magus_memory_v1alpha1_memory_proto_enumTypes[0]
}
...
func (MemoryType) EnumDescriptor() ([]byte, []int) {
	return file_magus_memory_v1alpha1_memory_proto_rawDescGZIP(), []int{0}
}
...
func (MemoryRefKind) Descriptor() protoreflect.EnumDescriptor {
	return file_magus_memory_v1alpha1_memory_proto_enumTypes[1].Descriptor()
}

func (MemoryRefKind) Type() protoreflect.EnumType {
	return &file_magus_memory_v1alpha1_memory_proto_enumTypes[1]
}
...
func (MemoryRefKind) EnumDescriptor() ([]byte, []int) {
	return file_magus_memory_v1alpha1_memory_proto_rawDescGZIP(), []int{1}
}

// MemoryRef is one typed pointer: the payload of a record.
type MemoryRef struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Kind          MemoryRefKind          `protobuf:"varint,1,opt,name=kind,proto3,enum=magus.memory.v1alpha1.MemoryRefKind" json:"kind,omitempty"`
...
func (x *MemoryRef) Reset() {
	*x = MemoryRef{}
	mi := &file_magus_memory_v1alpha1_memory_proto_msgTypes[0]
...
func (x *Memory) Reset() {
	*x = Memory{}
	mi := &file_magus_memory_v1alpha1_memory_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *ListMemoriesRequest) Reset() {
	*x = ListMemoriesRequest{}
	mi := &file_magus_memory_v1alpha1_memory_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ListMemoriesRequest) Descriptor() ([]byte, []int) {
	return file_magus_memory_v1alpha1_memory_proto_rawDescGZIP(), []int{2}
}
...
func (x *ListMemoriesResponse) Reset() {
	*x = ListMemoriesResponse{}
	mi := &file_magus_memory_v1alpha1_memory_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ListMemoriesResponse) Descriptor() ([]byte, []int) {
	return file_magus_memory_v1alpha1_memory_proto_rawDescGZIP(), []int{3}
}
...
func (x *UpdateMemoryRequest) Reset() {
	*x = UpdateMemoryRequest{}
	mi := &file_magus_memory_v1alpha1_memory_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*UpdateMemoryRequest) Descriptor() ([]byte, []int) {
	return file_magus_memory_v1alpha1_memory_proto_rawDescGZIP(), []int{4}
}
...
var File_magus_memory_v1alpha1_memory_proto protoreflect.FileDescriptor

const file_magus_memory_v1alpha1_memory_proto_rawDesc = "" +
	"\n" +
	"\"magus/memory/v1alpha1/memory.proto\x12\x15magus.memory.v1alpha1\x1a google/protobuf/field_mask.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"]\n" +
	"\tMemoryRef\x128\n" +
	...
	"\x04refs\x18\x03 \x03(\v2 .magus.memory.v1alpha1.MemoryRefR\x04refs\x12\x16\n" +
	...
	"\bmemories\x18\x01 \x03(\v2\x1d.magus.memory.v1alpha1.MemoryR\bmemories\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\"\xae\x01\n" +
	"\x13UpdateMemoryRequest\x125\n" +
...
var (
	file_magus_memory_v1alpha1_memory_proto_rawDescOnce sync.Once
	file_magus_memory_v1alpha1_memory_proto_rawDescData []byte
)

func file_magus_memory_v1alpha1_memory_proto_rawDescGZIP() []byte {
	file_magus_memory_v1alpha1_memory_proto_rawDescOnce.Do(func() {
		file_magus_memory_v1alpha1_memory_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_magus_memory_v1alpha1_memory_proto_rawDesc), len(file_magus_memory_v1alpha1_memory_proto_rawDesc)))
	})
	return file_magus_memory_v1alpha1_memory_proto_rawDescData
}
...
var file_magus_memory_v1alpha1_memory_proto_goTypes = []any{
	...
	(*MemoryRef)(nil),             // 2: magus.memory.v1alpha1.MemoryRef
	(*Memory)(nil),                // 3: magus.memory.v1alpha1.Memory
...
func file_magus_memory_v1alpha1_memory_proto_init() {
	if File_magus_memory_v1alpha1_memory_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_magus_memory_v1alpha1_memory_proto_goTypes,
		DependencyIndexes: file_magus_memory_v1alpha1_memory_proto_depIdxs,
		EnumInfos:         file_magus_memory_v1alpha1_memory_proto_enumTypes,
		MessageInfos:      file_magus_memory_v1alpha1_memory_proto_msgTypes,
	}.Build()
	File_magus_memory_v1alpha1_memory_proto = out.File
	file_magus_memory_v1alpha1_memory_proto_goTypes = nil
	file_magus_memory_v1alpha1_memory_proto_depIdxs = nil
}
