...
package memoryv1alpha1connect

import (
	connect "connectrpc.com/connect"
	context "context"
	errors "errors"
	v1alpha1 "github.com/egladman/magus/proto/gen/go/magus/memory/v1alpha1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	MemoryServiceName = "magus.memory.v1alpha1.MemoryService"
)
...
const (
	...
	// ListMemories RPC.
	MemoryServiceListMemoriesProcedure = "/magus.memory.v1alpha1.MemoryService/ListMemories"
	// MemoryServiceUpdateMemoryProcedure is the fully-qualified name of the MemoryService's
	// UpdateMemory RPC.
	MemoryServiceUpdateMemoryProcedure = "/magus.memory.v1alpha1.MemoryService/UpdateMemory"
	// MemoryServiceDeleteMemoryProcedure is the fully-qualified name of the MemoryService's
	// DeleteMemory RPC.
	MemoryServiceDeleteMemoryProcedure = "/magus.memory.v1alpha1.MemoryService/DeleteMemory"
	// MemoryServiceGetCursorProcedure is the fully-qualified name of the MemoryService's GetCursor RPC.
	MemoryServiceGetCursorProcedure = "/magus.memory.v1alpha1.MemoryService/GetCursor"
	// MemoryServiceUpdateCursorProcedure is the fully-qualified name of the MemoryService's
	// UpdateCursor RPC.
	MemoryServiceUpdateCursorProcedure = "/magus.memory.v1alpha1.MemoryService/UpdateCursor"
)

// MemoryServiceClient is a client for the magus.memory.v1alpha1.MemoryService service.
...
func NewMemoryServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) MemoryServiceClient {
	...
	memoryServiceMethods := v1alpha1.File_magus_memory_v1alpha1_memory_proto.Services().ByName("MemoryService").Methods()
	return &memoryServiceClient{
		listMemories: connect.NewClient[v1alpha1.ListMemoriesRequest, v1alpha1.ListMemoriesResponse](
			httpClient,
		...
		deleteMemory: connect.NewClient[v1alpha1.DeleteMemoryRequest, v1alpha1.DeleteMemoryResponse](
			httpClient,
...
func (c *memoryServiceClient) ListMemories(ctx context.Context, req *connect.Request[v1alpha1.ListMemoriesRequest]) (*connect.Response[v1alpha1.ListMemoriesResponse], error) {
...
// DeleteMemory calls magus.memory.v1alpha1.MemoryService.DeleteMemory.
func (c *memoryServiceClient) DeleteMemory(ctx context.Context, req *connect.Request[v1alpha1.DeleteMemoryRequest]) (*connect.Response[v1alpha1.DeleteMemoryResponse], error) {
...
// MemoryServiceHandler is an implementation of the magus.memory.v1alpha1.MemoryService service.
...
func NewMemoryServiceHandler(svc MemoryServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/magus.memory.v1alpha1.MemoryService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedMemoryServiceHandler) ListMemories(context.Context, *connect.Request[v1alpha1.ListMemoriesRequest]) (*connect.Response[v1alpha1.ListMemoriesResponse], error) {
...
func (UnimplementedMemoryServiceHandler) DeleteMemory(context.Context, *connect.Request[v1alpha1.DeleteMemoryRequest]) (*connect.Response[v1alpha1.DeleteMemoryResponse], error) {
