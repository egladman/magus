...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/egladman/magus/proto/gen/go/magus/notes/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	NotesServiceName = "magus.notes.v1.NotesService"
)
...
const (
	...
	NotesServiceListNotesProcedure = "/magus.notes.v1.NotesService/ListNotes"
	// NotesServiceGetNoteProcedure is the fully-qualified name of the NotesService's GetNote RPC.
	NotesServiceGetNoteProcedure = "/magus.notes.v1.NotesService/GetNote"
)

// NotesServiceClient is a client for the magus.notes.v1.NotesService service.
...
// NewNotesServiceClient constructs a client for the magus.notes.v1.NotesService service. By
...
func NewNotesServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) NotesServiceClient {
	...
	notesServiceMethods := v1.File_magus_notes_v1_notes_proto.Services().ByName("NotesService").Methods()
...
// ListNotes calls magus.notes.v1.NotesService.ListNotes.
...
// GetNote calls magus.notes.v1.NotesService.GetNote.
...
// NotesServiceHandler is an implementation of the magus.notes.v1.NotesService service.
...
func NewNotesServiceHandler(svc NotesServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/magus.notes.v1.NotesService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedNotesServiceHandler) ListNotes(context.Context, *connect.Request[v1.ListNotesRequest]) (*connect.Response[v1.ListNotesResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("magus.notes.v1.NotesService.ListNotes is not implemented"))
}
...
func (UnimplementedNotesServiceHandler) GetNote(context.Context, *connect.Request[v1.GetNoteRequest]) (*connect.Response[v1.GetNoteResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("magus.notes.v1.NotesService.GetNote is not implemented"))
}
