...
import (
	...
	context "context"
	errors "errors"
	v1alpha1 "github.com/egladman/magus/proto/gen/go/magus/insight/v1alpha1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	InsightServiceName = "magus.insight.v1alpha1.InsightService"
)
...
const (
	...
	// RPC.
	InsightServiceGetInsightProcedure = "/magus.insight.v1alpha1.InsightService/GetInsight"
)
...
func NewInsightServiceHandler(svc InsightServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/magus.insight.v1alpha1.InsightService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
