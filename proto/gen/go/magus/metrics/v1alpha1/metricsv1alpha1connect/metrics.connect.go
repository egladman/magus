...
import (
	...
	context "context"
	errors "errors"
	v1alpha1 "github.com/egladman/magus/proto/gen/go/magus/metrics/v1alpha1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	MetricsServiceName = "magus.metrics.v1alpha1.MetricsService"
)
...
const (
	...
	// RPC.
	MetricsServiceGetMetricsProcedure = "/magus.metrics.v1alpha1.MetricsService/GetMetrics"
	// MetricsServiceStreamMetricsProcedure is the fully-qualified name of the MetricsService's
	// StreamMetrics RPC.
	MetricsServiceStreamMetricsProcedure = "/magus.metrics.v1alpha1.MetricsService/StreamMetrics"
)
...
// NewMetricsServiceClient constructs a client for the magus.metrics.v1alpha1.MetricsService
...
func NewMetricsServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) MetricsServiceClient {
	...
	return &metricsServiceClient{
		...
		streamMetrics: connect.NewClient[v1alpha1.StreamMetricsRequest, v1alpha1.StreamMetricsResponse](
			httpClient,
...
// StreamMetrics calls magus.metrics.v1alpha1.MetricsService.StreamMetrics.
func (c *metricsServiceClient) StreamMetrics(ctx context.Context, req *connect.Request[v1alpha1.StreamMetricsRequest]) (*connect.ServerStreamForClient[v1alpha1.StreamMetricsResponse], error) {
...
func NewMetricsServiceHandler(svc MetricsServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/magus.metrics.v1alpha1.MetricsService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedMetricsServiceHandler) StreamMetrics(context.Context, *connect.Request[v1alpha1.StreamMetricsRequest], *connect.ServerStream[v1alpha1.StreamMetricsResponse]) error {
	return connect.NewError(connect.CodeUnimplemented, errors.New("magus.metrics.v1alpha1.MetricsService.StreamMetrics is not implemented"))
}
